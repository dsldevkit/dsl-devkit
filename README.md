...
===================================
![Snapshot](https://github.com/dsldevkit/dsl-devkit/actions/workflows/snapshot.yml/badge.svg?branch=master)
...
> **Browse available releases and snapshots:** [dsldevkit.github.io/dsl-devkit/](https://dsldevkit.github.io/dsl-devkit/)
> Note: subdirectory URLs (e.g. `/p2/releases/latest/`) are for Eclipse only and return 404 in a browser.
