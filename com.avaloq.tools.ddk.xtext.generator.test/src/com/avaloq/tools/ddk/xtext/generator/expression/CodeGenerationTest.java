 ...
 */
public class CodeGenerationTest extends AbstractXtextTest {

  private Compiler getCompiler() {
    return (Compiler) getTestInformation().getTestObject(Compiler.class);
  }
  ...
  protected void beforeAllTests() {
    ...
    getTestInformation().putTestObject(Compiler.class, new Compiler(context));
  }
