...
public class TypeModelAdapterFactory extends AdapterFactoryImpl
{
	...
	protected TypeModelSwitch<Adapter> modelSwitch =
		new TypeModelSwitch<Adapter>()
		{
			...
			@Override
			public Adapter caseICustomExportedName(ICustomExportedName object)
			{
				return createICustomExportedNameAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.avaloq.tools.ddk.typesystem.typemodel.ICustomExportedName <em>ICustom Exported Name</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
