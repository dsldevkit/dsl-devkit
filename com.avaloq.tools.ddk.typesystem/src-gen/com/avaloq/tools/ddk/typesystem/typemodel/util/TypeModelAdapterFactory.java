...
public class TypeModelAdapterFactory extends AdapterFactoryImpl
{
	...
	protected TypeModelSwitch<Adapter> modelSwitch =
		new TypeModelSwitch<Adapter>()
		{
			...
			@Override
			public Adapter caseObsoleteElement(ObsoleteElement object)
			{
				return createObsoleteElementAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.avaloq.tools.ddk.typesystem.typemodel.ObsoleteElement <em>Obsolete Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createObsoleteElementAdapter()
	{
		return null;
	}
