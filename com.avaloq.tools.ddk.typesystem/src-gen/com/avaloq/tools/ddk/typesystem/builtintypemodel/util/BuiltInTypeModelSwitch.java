...
public class BuiltInTypeModelSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		switch (classifierID)
		{
			case BuiltInTypeModelPackage.BUILT_IN_TYPE_MODEL:
			{
				BuiltInTypeModel builtInTypeModel = (BuiltInTypeModel)theEObject;
				T result = caseBuiltInTypeModel(builtInTypeModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BuiltInTypeModelPackage.INTERNAL_TYPE:
			{
				InternalType internalType = (InternalType)theEObject;
				T result = caseInternalType(internalType);
				if (result == null) result = caseINamedType(internalType);
				if (result == null) result = caseINamedElement(internalType);
				if (result == null) result = caseIType(internalType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Built In Type Model</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Built In Type Model</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBuiltInTypeModel(BuiltInTypeModel object)
	{
		return null;
	}
