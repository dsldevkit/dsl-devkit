...
/**
 * DDK-specific builder integration fragment.
 */
  ...
  protected void addEclipsePluginGuiceBindings() {
    ...
    final StringConcatenationClient statement1 = new StringConcatenationClient() {
      ...
      protected void appendTo(final TargetStringConcatenation target) {
        ...
        target.append(IResourceDescriptions.class);
        target.append(".class");
        target.newLineIfNotEmpty();
        target.append(").annotatedWith(");
        target.append(Names.class);
        target.append(".named(");
        target.append(ResourceDescriptionsProvider.class);
