 ...
 */
class AnnotationAwareAntlrContentAssistGrammarGenerator extends AbstractAnnotationAwareAntlrGrammarGenerator {
  @Inject
  ...
  override protected compileParserMembers(Grammar it, AntlrOptions options) '''
    @«IF combinedGrammar»parser::«ENDIF»members {
      «compileParserMemberDeclarations("protected")»
      «IF !combinedGrammar»
      ...
      public void setPredicates(«getSemanticPredicatesSimpleName» predicates) {
