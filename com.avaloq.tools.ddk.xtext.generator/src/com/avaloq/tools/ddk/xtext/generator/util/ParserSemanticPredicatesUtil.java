...
public final class ParserSemanticPredicatesUtil {
  ...
  private static final GrammarAccessExtensions GRAMMAR_EXTENSIONS = new GrammarAccessExtensions();
  ...
  private static String getText(final AbstractRule rule) {
    ...
    return node != null ? node.getText() : GRAMMAR_EXTENSIONS.grammarFragmentToString(rule, ""); //$NON-NLS-1$
  }
