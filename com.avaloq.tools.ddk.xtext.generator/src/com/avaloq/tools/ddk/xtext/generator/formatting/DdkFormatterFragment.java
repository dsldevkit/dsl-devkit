...
/**
 * This class overrides {@link FormatterFragment} in order to add DDK functionality to
 * Acf languages. Presently the added functionality is to replace the stock NodeModelFormatter with {@link RegionNodeModelFormatter}.
 */
public class DdkFormatterFragment extends FormatterFragment {

  /** Class-wide logger. */
  private static final Logger LOGGER = Logger.getLogger(DdkFormatterFragment.class);
  ...
  public Set<Binding> getGuiceBindingsRt(final Grammar grammar) {
    ...
    bindings.addAll(bindFactory.addTypeToType(INodeModelStreamer.class.getName(), DdkNodeModelStreamer.class.getName()).getBindings());
    return bindings;
  }
  ...
  protected String getTemplate() {
    // there is no DdkFormatterFragment.xpt - this will cause FormatterFragment.xpt to be used
