...
public class CompilationContext {
   ...
   */
  public CompilationContext(final ExecutionContext context, final String implicitVar, final Type contextType) {
    this.context = context;
  ...
  public CompilationContext cloneWithString(final String implicitVar, final EClass contextType, final String variable) {
    return new CompilationContext(context.cloneWithVariable(new Variable(variable, "")), implicitVar, contextType != null ? findType(contextType) //$NON-NLS-1$
  ...
  public CompilationContext cloneWithVariable(final String implicitVar, final EClass contextType, final String variable, final String type) {
    return new CompilationContext(context.cloneWithVariable(new Variable(variable, type)), implicitVar, contextType != null ? findType(contextType)
        : this.implicitContextType);
  }
  ...
  public String javaType(final Type type) {
    if (type instanceof EClassType) {
      ...
      return GenModelUtil2.getInstanceClassName(eClass);
    }
  ...
  public CompilationContext clone(final String implicitVar) {
    return new CompilationContext(context, implicitVar, implicitContextType);
  }
  ...
  public CompilationContext clone(final String implicitVar, final EClass contextType) {
    return new CompilationContext(context, implicitVar, contextType != null ? findType(contextType) : this.implicitContextType);
  }
