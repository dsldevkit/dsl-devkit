 ...
 */
public class DdkEcoreGenerator extends EcoreGenerator implements IWorkflowComponent {
  ...
  public void addSrcPath(final String srcPath) {
    throw new AssertionFailedException("srcPath should not be used in DdkEcoreGenerator");
  }
