 ...
 * </p>
 * <ul>
 *   <li>{@link com.avaloq.tools.ddk.xtext.expression.expression.impl.ListLiteralImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ListLiteralImpl extends ExpressionImpl implements ListLiteral
{
  ...
  public EList<Expression> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Expression>(Expression.class, this, ExpressionPackage.LIST_LITERAL__ELEMENTS);
    }
    return elements;
  }
