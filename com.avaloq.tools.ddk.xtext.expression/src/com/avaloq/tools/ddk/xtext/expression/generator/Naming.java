...
public class Naming {
  ...
  public String toFileName(final String qualifiedName) {
    return toJavaPackage(qualifiedName).replace(DOT, "/") + "/" + toSimpleName(qualifiedName) + ".java";
  }

  public String toJavaPackage(final String qualifiedName) {
    return Strings.skipLastToken(qualifiedName, DOT);
  }

  public String toSimpleName(final String qualifiedName) {
    return Strings.lastToken(qualifiedName, DOT);
  }
