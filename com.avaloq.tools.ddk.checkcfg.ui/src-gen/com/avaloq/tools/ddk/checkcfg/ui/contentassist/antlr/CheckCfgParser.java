 ...
 * generated by Xtext
 */
package com.avaloq.tools.ddk.checkcfg.ui.contentassist.antlr;
...
public class CheckCfgParser extends AbstractContentAssistParser {
	...
	@Override
	protected com.avaloq.tools.ddk.checkcfg.ui.contentassist.antlr.internal.InternalCheckCfgParser createParser() {
		com.avaloq.tools.ddk.checkcfg.ui.contentassist.antlr.internal.InternalCheckCfgParser result = new com.avaloq.tools.ddk.checkcfg.ui.contentassist.antlr.internal.InternalCheckCfgParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getConfiguredCheckAccess().getGroup_3(), "rule__ConfiguredCheck__Group_3__0");
					put(grammarAccess.getConfiguredCheckAccess().getGroup_3_2(), "rule__ConfiguredCheck__Group_3_2__0");
					put(grammarAccess.getConfiguredParameterAccess().getGroup(), "rule__ConfiguredParameter__Group__0");
					...
					put(grammarAccess.getConfiguredCheckAccess().getParameterConfigurationsAssignment_3_2_1(), "rule__ConfiguredCheck__ParameterConfigurationsAssignment_3_2_1");
					put(grammarAccess.getConfiguredParameterAccess().getParameterAssignment_1(), "rule__ConfiguredParameter__ParameterAssignment_1");
					put(grammarAccess.getConfiguredParameterAccess().getNewValueAssignment_3(), "rule__ConfiguredParameter__NewValueAssignment_3");
