 ...
 */
package com.avaloq.tools.ddk.checkcfg.ide.contentassist.antlr;

import com.avaloq.tools.ddk.checkcfg.ide.contentassist.antlr.internal.InternalCheckCfgParser;
...
public class CheckCfgParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(CheckCfgGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CheckCfgGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCheckConfigurationAccess().getGroup(), "rule__CheckConfiguration__Group__0");
			builder.put(grammarAccess.getCheckConfigurationAccess().getGroup_5(), "rule__CheckConfiguration__Group_5__0");
			builder.put(grammarAccess.getConfiguredLanguageValidatorAccess().getGroup(), "rule__ConfiguredLanguageValidator__Group__0");
			builder.put(grammarAccess.getConfiguredCatalogAccess().getGroup(), "rule__ConfiguredCatalog__Group__0");
			builder.put(grammarAccess.getConfiguredCheckAccess().getGroup(), "rule__ConfiguredCheck__Group__0");
			builder.put(grammarAccess.getConfiguredCheckAccess().getGroup_3(), "rule__ConfiguredCheck__Group_3__0");
			builder.put(grammarAccess.getConfiguredCheckAccess().getGroup_3_2(), "rule__ConfiguredCheck__Group_3_2__0");
			builder.put(grammarAccess.getConfiguredParameterAccess().getGroup(), "rule__ConfiguredParameter__Group__0");
			...
			builder.put(grammarAccess.getCheckConfigurationAccess().getNameAssignment_2(), "rule__CheckConfiguration__NameAssignment_2");
			builder.put(grammarAccess.getCheckConfigurationAccess().getParameterConfigurationsAssignment_3(), "rule__CheckConfiguration__ParameterConfigurationsAssignment_3");
			builder.put(grammarAccess.getCheckConfigurationAccess().getLanguageValidatorConfigurationsAssignment_4(), "rule__CheckConfiguration__LanguageValidatorConfigurationsAssignment_4");
			builder.put(grammarAccess.getCheckConfigurationAccess().getLegacyCatalogConfigurationsAssignment_5_1(), "rule__CheckConfiguration__LegacyCatalogConfigurationsAssignment_5_1");
			builder.put(grammarAccess.getConfiguredLanguageValidatorAccess().getLanguageAssignment_1(), "rule__ConfiguredLanguageValidator__LanguageAssignment_1");
			builder.put(grammarAccess.getConfiguredLanguageValidatorAccess().getParameterConfigurationsAssignment_3(), "rule__ConfiguredLanguageValidator__ParameterConfigurationsAssignment_3");
			builder.put(grammarAccess.getConfiguredLanguageValidatorAccess().getCatalogConfigurationsAssignment_4(), "rule__ConfiguredLanguageValidator__CatalogConfigurationsAssignment_4");
			builder.put(grammarAccess.getConfiguredCatalogAccess().getCatalogAssignment_2(), "rule__ConfiguredCatalog__CatalogAssignment_2");
			builder.put(grammarAccess.getConfiguredCatalogAccess().getParameterConfigurationsAssignment_4(), "rule__ConfiguredCatalog__ParameterConfigurationsAssignment_4");
			builder.put(grammarAccess.getConfiguredCatalogAccess().getCheckConfigurationsAssignment_5(), "rule__ConfiguredCatalog__CheckConfigurationsAssignment_5");
			builder.put(grammarAccess.getConfiguredCheckAccess().getSeverityAssignment_1(), "rule__ConfiguredCheck__SeverityAssignment_1");
			builder.put(grammarAccess.getConfiguredCheckAccess().getCheckAssignment_2(), "rule__ConfiguredCheck__CheckAssignment_2");
			builder.put(grammarAccess.getConfiguredCheckAccess().getParameterConfigurationsAssignment_3_1(), "rule__ConfiguredCheck__ParameterConfigurationsAssignment_3_1");
			builder.put(grammarAccess.getConfiguredCheckAccess().getParameterConfigurationsAssignment_3_2_1(), "rule__ConfiguredCheck__ParameterConfigurationsAssignment_3_2_1");
			builder.put(grammarAccess.getConfiguredParameterAccess().getParameterAssignment_1(), "rule__ConfiguredParameter__ParameterAssignment_1");
			builder.put(grammarAccess.getConfiguredParameterAccess().getNewValueAssignment_3(), "rule__ConfiguredParameter__NewValueAssignment_3");
	...
	@Override
	protected InternalCheckCfgParser createParser() {
		InternalCheckCfgParser result = new InternalCheckCfgParser(null);
