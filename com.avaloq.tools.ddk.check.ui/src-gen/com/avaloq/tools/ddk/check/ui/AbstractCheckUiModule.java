...
import com.avaloq.tools.ddk.check.ide.contentassist.antlr.CheckParser;
import com.avaloq.tools.ddk.check.ide.contentassist.antlr.PartialCheckContentAssistParser;
import com.avaloq.tools.ddk.check.ide.contentassist.antlr.internal.InternalCheckLexer;
import com.avaloq.tools.ddk.check.ui.contentassist.CheckProposalProvider;
import com.avaloq.tools.ddk.check.ui.editor.CheckEditor;
import com.avaloq.tools.ddk.check.ui.labeling.CheckDescriptionLabelProvider;
import com.avaloq.tools.ddk.check.ui.labeling.CheckLabelProvider;
import com.avaloq.tools.ddk.check.ui.outline.CheckOutlineTreeProvider;
import com.avaloq.tools.ddk.check.ui.quickfix.CheckQuickfixProvider;
...
/**
 * Manual modifications go to {@link CheckUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractCheckUiModule extends DefaultXbaseWithAnnotationsUiModule {
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(com.avaloq.tools.ddk.check.parser.antlr.internal.InternalCheckLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalCheckLexer.class).toProvider(LexerProvider.create(InternalCheckLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return CheckLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(CheckDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return CheckOutlineTreeProvider.class;
	}
	...
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return CheckProposalProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return CheckQuickfixProvider.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Check Compare");
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialCheckContentAssistParser.class;
	}
