...
public class CheckParser extends AbstractContentAssistParser {
	...
	@Override
	protected com.avaloq.tools.ddk.check.ui.contentassist.antlr.internal.InternalCheckParser createParser() {
		com.avaloq.tools.ddk.check.ui.contentassist.antlr.internal.InternalCheckParser result = new com.avaloq.tools.ddk.check.ui.contentassist.antlr.internal.InternalCheckParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCheckAccess().getAlternatives_8(), "rule__Check__Alternatives_8");
					put(grammarAccess.getXSimpleFormalParameterDefaultValueLiteralAccess().getAlternatives(), "rule__XSimpleFormalParameterDefaultValueLiteral__Alternatives");
					put(grammarAccess.getXConstantUnaryOperationAccess().getAlternatives(), "rule__XConstantUnaryOperation__Alternatives");
					put(grammarAccess.getXFormalParameterDefaultValueLiteralAccess().getAlternatives(), "rule__XFormalParameterDefaultValueLiteral__Alternatives");
					put(grammarAccess.getXIssueExpressionAccess().getAlternatives_3_1(), "rule__XIssueExpression__Alternatives_3_1");
					...
					put(grammarAccess.getCheckAccess().getGroup_6_1(), "rule__Check__Group_6_1__0");
					put(grammarAccess.getCheckAccess().getGroup_6_1_1(), "rule__Check__Group_6_1_1__0");
					put(grammarAccess.getCheckAccess().getGroup_7(), "rule__Check__Group_7__0");
					put(grammarAccess.getCheckAccess().getGroup_8_0(), "rule__Check__Group_8_0__0");
					put(grammarAccess.getSeverityRangeAccess().getGroup(), "rule__SeverityRange__Group__0");
					...
					put(grammarAccess.getXConstantUnaryOperationAccess().getGroup_0(), "rule__XConstantUnaryOperation__Group_0__0");
					put(grammarAccess.getXConstantListLiteralAccess().getGroup(), "rule__XConstantListLiteral__Group__0");
					put(grammarAccess.getXConstantListLiteralAccess().getGroup_3(), "rule__XConstantListLiteral__Group_3__0");
					put(grammarAccess.getXConstantListLiteralAccess().getGroup_3_1(), "rule__XConstantListLiteral__Group_3_1__0");
					...
					put(grammarAccess.getXGuardExpressionAccess().getGroup(), "rule__XGuardExpression__Group__0");
					put(grammarAccess.getXIssueExpressionAccess().getGroup(), "rule__XIssueExpression__Group__0");
					put(grammarAccess.getXIssueExpressionAccess().getGroup_3(), "rule__XIssueExpression__Group_3__0");
					put(grammarAccess.getXIssueExpressionAccess().getGroup_3_1_0(), "rule__XIssueExpression__Group_3_1_0__0");
					put(grammarAccess.getXIssueExpressionAccess().getGroup_3_1_1(), "rule__XIssueExpression__Group_3_1_1__0");
					put(grammarAccess.getXIssueExpressionAccess().getGroup_3_1_1_1(), "rule__XIssueExpression__Group_3_1_1_1__0");
					put(grammarAccess.getXIssueExpressionAccess().getGroup_3_2(), "rule__XIssueExpression__Group_3_2__0");
					put(grammarAccess.getXIssueExpressionAccess().getGroup_4(), "rule__XIssueExpression__Group_4__0");
					put(grammarAccess.getXIssueExpressionAccess().getGroup_5(), "rule__XIssueExpression__Group_5__0");
					put(grammarAccess.getXIssueExpressionAccess().getGroup_5_3(), "rule__XIssueExpression__Group_5_3__0");
					put(grammarAccess.getXIssueExpressionAccess().getGroup_6(), "rule__XIssueExpression__Group_6__0");
					put(grammarAccess.getXIssueExpressionAccess().getGroup_6_4(), "rule__XIssueExpression__Group_6_4__0");
					...
					put(grammarAccess.getCheckCatalogAccess().getPackageNameAssignment_2(), "rule__CheckCatalog__PackageNameAssignment_2");
					put(grammarAccess.getCheckCatalogAccess().getImportsAssignment_3(), "rule__CheckCatalog__ImportsAssignment_3");
					...
					put(grammarAccess.getCategoryAccess().getLabelAssignment_2(), "rule__Category__LabelAssignment_2");
					put(grammarAccess.getCategoryAccess().getChecksAssignment_4(), "rule__Category__ChecksAssignment_4");
					put(grammarAccess.getCheckAccess().getSeverityRangeAssignment_0(), "rule__Check__SeverityRangeAssignment_0");
					put(grammarAccess.getCheckAccess().getFinalAssignment_1(), "rule__Check__FinalAssignment_1");
					put(grammarAccess.getCheckAccess().getKindAssignment_2(), "rule__Check__KindAssignment_2");
					put(grammarAccess.getCheckAccess().getDefaultSeverityAssignment_3(), "rule__Check__DefaultSeverityAssignment_3");
					put(grammarAccess.getCheckAccess().getIdAssignment_4(), "rule__Check__IdAssignment_4");
					put(grammarAccess.getCheckAccess().getLabelAssignment_5(), "rule__Check__LabelAssignment_5");
					put(grammarAccess.getCheckAccess().getFormalParametersAssignment_6_1_0(), "rule__Check__FormalParametersAssignment_6_1_0");
					put(grammarAccess.getCheckAccess().getFormalParametersAssignment_6_1_1_1(), "rule__Check__FormalParametersAssignment_6_1_1_1");
					put(grammarAccess.getCheckAccess().getGivenMessageAssignment_7_1(), "rule__Check__GivenMessageAssignment_7_1");
					put(grammarAccess.getCheckAccess().getContextsAssignment_8_0_1(), "rule__Check__ContextsAssignment_8_0_1");
					put(grammarAccess.getCheckAccess().getContextsAssignment_8_1(), "rule__Check__ContextsAssignment_8_1");
					put(grammarAccess.getSeverityRangeAccess().getMinSeverityAssignment_3(), "rule__SeverityRange__MinSeverityAssignment_3");
					put(grammarAccess.getSeverityRangeAccess().getMaxSeverityAssignment_5(), "rule__SeverityRange__MaxSeverityAssignment_5");
					put(grammarAccess.getMemberAccess().getAnnotationsAssignment_0(), "rule__Member__AnnotationsAssignment_0");
					...
					put(grammarAccess.getMemberAccess().getValueAssignment_3_1(), "rule__Member__ValueAssignment_3_1");
					put(grammarAccess.getImplementationAccess().getNameAssignment_1(), "rule__Implementation__NameAssignment_1");
					put(grammarAccess.getImplementationAccess().getContextAssignment_2(), "rule__Implementation__ContextAssignment_2");
					...
					put(grammarAccess.getFormalParameterAccess().getRightAssignment_3(), "rule__FormalParameter__RightAssignment_3");
					put(grammarAccess.getFormalParameterAccess().getLabelAssignment_4(), "rule__FormalParameter__LabelAssignment_4");
					put(grammarAccess.getXConstantUnaryOperationAccess().getFeatureAssignment_0_1(), "rule__XConstantUnaryOperation__FeatureAssignment_0_1");
					put(grammarAccess.getXConstantUnaryOperationAccess().getOperandAssignment_0_2(), "rule__XConstantUnaryOperation__OperandAssignment_0_2");
					put(grammarAccess.getXConstantListLiteralAccess().getElementsAssignment_3_0(), "rule__XConstantListLiteral__ElementsAssignment_3_0");
					put(grammarAccess.getXConstantListLiteralAccess().getElementsAssignment_3_1_1(), "rule__XConstantListLiteral__ElementsAssignment_3_1_1");
					put(grammarAccess.getContextAccess().getContextVariableAssignment_1(), "rule__Context__ContextVariableAssignment_1");
					put(grammarAccess.getContextAccess().getConstraintAssignment_2(), "rule__Context__ConstraintAssignment_2");
					put(grammarAccess.getContextVariableAccess().getTypeAssignment_0(), "rule__ContextVariable__TypeAssignment_0");
					put(grammarAccess.getContextVariableAccess().getNameAssignment_1(), "rule__ContextVariable__NameAssignment_1");
					put(grammarAccess.getXGuardExpressionAccess().getGuardAssignment_2(), "rule__XGuardExpression__GuardAssignment_2");
					put(grammarAccess.getXIssueExpressionAccess().getCheckAssignment_2(), "rule__XIssueExpression__CheckAssignment_2");
					put(grammarAccess.getXIssueExpressionAccess().getMarkerFeatureAssignment_3_1_0_1(), "rule__XIssueExpression__MarkerFeatureAssignment_3_1_0_1");
					put(grammarAccess.getXIssueExpressionAccess().getMarkerObjectAssignment_3_1_1_0(), "rule__XIssueExpression__MarkerObjectAssignment_3_1_1_0");
					put(grammarAccess.getXIssueExpressionAccess().getMarkerFeatureAssignment_3_1_1_1_1(), "rule__XIssueExpression__MarkerFeatureAssignment_3_1_1_1_1");
					put(grammarAccess.getXIssueExpressionAccess().getMarkerIndexAssignment_3_2_1(), "rule__XIssueExpression__MarkerIndexAssignment_3_2_1");
					put(grammarAccess.getXIssueExpressionAccess().getMessageAssignment_4_1(), "rule__XIssueExpression__MessageAssignment_4_1");
					put(grammarAccess.getXIssueExpressionAccess().getMessageParametersAssignment_5_2(), "rule__XIssueExpression__MessageParametersAssignment_5_2");
					put(grammarAccess.getXIssueExpressionAccess().getMessageParametersAssignment_5_3_1(), "rule__XIssueExpression__MessageParametersAssignment_5_3_1");
					put(grammarAccess.getXIssueExpressionAccess().getIssueCodeAssignment_6_1(), "rule__XIssueExpression__IssueCodeAssignment_6_1");
					put(grammarAccess.getXIssueExpressionAccess().getIssueDataAssignment_6_3(), "rule__XIssueExpression__IssueDataAssignment_6_3");
					put(grammarAccess.getXIssueExpressionAccess().getIssueDataAssignment_6_4_1(), "rule__XIssueExpression__IssueDataAssignment_6_4_1");
