...
Then run `bash ./.github/scripts/check-surefire-reports.sh` from the checkout.
...
faster. The example raises the test-runtime timeout (`test.timeout`, 1,800 in the parent POM) to 7,200
