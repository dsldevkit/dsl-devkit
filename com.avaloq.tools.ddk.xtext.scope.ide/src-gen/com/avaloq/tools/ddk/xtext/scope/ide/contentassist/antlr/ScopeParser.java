 ...
 */
package com.avaloq.tools.ddk.xtext.scope.ide.contentassist.antlr;

import com.avaloq.tools.ddk.xtext.scope.ide.contentassist.antlr.internal.InternalScopeParser;
...
public class ScopeParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(ScopeGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ScopeGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getScopeDefinitionAccess().getAlternatives_2(), "rule__ScopeDefinition__Alternatives_2");
			builder.put(grammarAccess.getScopeContextAccess().getAlternatives_0(), "rule__ScopeContext__Alternatives_0");
			builder.put(grammarAccess.getScopeExpressionAccess().getAlternatives(), "rule__ScopeExpression__Alternatives");
			builder.put(grammarAccess.getScopeDelegationAccess().getAlternatives_2(), "rule__ScopeDelegation__Alternatives_2");
			builder.put(grammarAccess.getNamedScopeExpressionAccess().getAlternatives_0(), "rule__NamedScopeExpression__Alternatives_0");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getAlternatives_3(), "rule__GlobalScopeExpression__Alternatives_3");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getAlternatives_5_3(), "rule__GlobalScopeExpression__Alternatives_5_3");
			builder.put(grammarAccess.getDataExpressionAccess().getAlternatives(), "rule__DataExpression__Alternatives");
			builder.put(grammarAccess.getNamingAccess().getAlternatives(), "rule__Naming__Alternatives");
			builder.put(grammarAccess.getNamingExpressionAccess().getAlternatives(), "rule__NamingExpression__Alternatives");
			...
			builder.put(grammarAccess.getCasingAccess().getAlternatives(), "rule__Casing__Alternatives");
			builder.put(grammarAccess.getScopeModelAccess().getGroup(), "rule__ScopeModel__Group__0");
			builder.put(grammarAccess.getScopeModelAccess().getGroup_2(), "rule__ScopeModel__Group_2__0");
			...
			builder.put(grammarAccess.getInjectionAccess().getGroup(), "rule__Injection__Group__0");
			builder.put(grammarAccess.getNamingSectionAccess().getGroup(), "rule__NamingSection__Group__0");
			builder.put(grammarAccess.getNamingSectionAccess().getGroup_1(), "rule__NamingSection__Group_1__0");
			builder.put(grammarAccess.getNamingDefinitionAccess().getGroup(), "rule__NamingDefinition__Group__0");
			builder.put(grammarAccess.getScopeDefinitionAccess().getGroup(), "rule__ScopeDefinition__Group__0");
			builder.put(grammarAccess.getScopeDefinitionAccess().getGroup_1(), "rule__ScopeDefinition__Group_1__0");
			builder.put(grammarAccess.getScopeDefinitionAccess().getGroup_2_1(), "rule__ScopeDefinition__Group_2_1__0");
			builder.put(grammarAccess.getScopeRuleAccess().getGroup(), "rule__ScopeRule__Group__0");
			builder.put(grammarAccess.getScopeRuleAccess().getGroup_4(), "rule__ScopeRule__Group_4__0");
			builder.put(grammarAccess.getScopeContextAccess().getGroup(), "rule__ScopeContext__Group__0");
			builder.put(grammarAccess.getScopeContextAccess().getGroup_1(), "rule__ScopeContext__Group_1__0");
			builder.put(grammarAccess.getFactoryExpressionAccess().getGroup(), "rule__FactoryExpression__Group__0");
			builder.put(grammarAccess.getScopeDelegationAccess().getGroup(), "rule__ScopeDelegation__Group__0");
			builder.put(grammarAccess.getScopeDelegationAccess().getGroup_3(), "rule__ScopeDelegation__Group_3__0");
			builder.put(grammarAccess.getNamedScopeExpressionAccess().getGroup(), "rule__NamedScopeExpression__Group__0");
			builder.put(grammarAccess.getNamedScopeExpressionAccess().getGroup_1(), "rule__NamedScopeExpression__Group_1__0");
			builder.put(grammarAccess.getNamedScopeExpressionAccess().getGroup_2(), "rule__NamedScopeExpression__Group_2__0");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getGroup(), "rule__GlobalScopeExpression__Group__0");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getGroup_3_0(), "rule__GlobalScopeExpression__Group_3_0__0");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getGroup_3_1(), "rule__GlobalScopeExpression__Group_3_1__0");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getGroup_4(), "rule__GlobalScopeExpression__Group_4__0");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getGroup_4_5(), "rule__GlobalScopeExpression__Group_4_5__0");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getGroup_5(), "rule__GlobalScopeExpression__Group_5__0");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getGroup_5_3_2(), "rule__GlobalScopeExpression__Group_5_3_2__0");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getGroup_5_3_2_2(), "rule__GlobalScopeExpression__Group_5_3_2_2__0");
			builder.put(grammarAccess.getMatchDataExpressionAccess().getGroup(), "rule__MatchDataExpression__Group__0");
			builder.put(grammarAccess.getLambdaDataExpressionAccess().getGroup(), "rule__LambdaDataExpression__Group__0");
			builder.put(grammarAccess.getNamingAccess().getGroup_0(), "rule__Naming__Group_0__0");
			builder.put(grammarAccess.getNamingAccess().getGroup_0_0(), "rule__Naming__Group_0_0__0");
			builder.put(grammarAccess.getNamingAccess().getGroup_0_0_2(), "rule__Naming__Group_0_0_2__0");
			builder.put(grammarAccess.getNamingExpressionAccess().getGroup_1(), "rule__NamingExpression__Group_1__0");
			...
			builder.put(grammarAccess.getScopeModelAccess().getNameAssignment_1(), "rule__ScopeModel__NameAssignment_1");
			builder.put(grammarAccess.getScopeModelAccess().getIncludedScopesAssignment_2_1(), "rule__ScopeModel__IncludedScopesAssignment_2_1");
			builder.put(grammarAccess.getScopeModelAccess().getImportsAssignment_3(), "rule__ScopeModel__ImportsAssignment_3");
			builder.put(grammarAccess.getScopeModelAccess().getExtensionsAssignment_4(), "rule__ScopeModel__ExtensionsAssignment_4");
			builder.put(grammarAccess.getScopeModelAccess().getInjectionsAssignment_5(), "rule__ScopeModel__InjectionsAssignment_5");
			builder.put(grammarAccess.getScopeModelAccess().getNamingAssignment_6(), "rule__ScopeModel__NamingAssignment_6");
			builder.put(grammarAccess.getScopeModelAccess().getScopesAssignment_7(), "rule__ScopeModel__ScopesAssignment_7");
			...
			builder.put(grammarAccess.getInjectionAccess().getTypeAssignment_1(), "rule__Injection__TypeAssignment_1");
			builder.put(grammarAccess.getInjectionAccess().getNameAssignment_3(), "rule__Injection__NameAssignment_3");
			builder.put(grammarAccess.getNamingSectionAccess().getCasingAssignment_1_1(), "rule__NamingSection__CasingAssignment_1_1");
			builder.put(grammarAccess.getNamingSectionAccess().getNamingsAssignment_4(), "rule__NamingSection__NamingsAssignment_4");
			builder.put(grammarAccess.getNamingDefinitionAccess().getTypeAssignment_0(), "rule__NamingDefinition__TypeAssignment_0");
			builder.put(grammarAccess.getNamingDefinitionAccess().getNamingAssignment_2(), "rule__NamingDefinition__NamingAssignment_2");
			builder.put(grammarAccess.getScopeDefinitionAccess().getNameAssignment_1_1(), "rule__ScopeDefinition__NameAssignment_1_1");
			builder.put(grammarAccess.getScopeDefinitionAccess().getTargetTypeAssignment_2_0(), "rule__ScopeDefinition__TargetTypeAssignment_2_0");
			builder.put(grammarAccess.getScopeDefinitionAccess().getContextTypeAssignment_2_1_0(), "rule__ScopeDefinition__ContextTypeAssignment_2_1_0");
			builder.put(grammarAccess.getScopeDefinitionAccess().getReferenceAssignment_2_1_2(), "rule__ScopeDefinition__ReferenceAssignment_2_1_2");
			builder.put(grammarAccess.getScopeDefinitionAccess().getRulesAssignment_4(), "rule__ScopeDefinition__RulesAssignment_4");
			builder.put(grammarAccess.getScopeRuleAccess().getContextAssignment_1(), "rule__ScopeRule__ContextAssignment_1");
			builder.put(grammarAccess.getScopeRuleAccess().getExprsAssignment_3(), "rule__ScopeRule__ExprsAssignment_3");
			builder.put(grammarAccess.getScopeRuleAccess().getExprsAssignment_4_1(), "rule__ScopeRule__ExprsAssignment_4_1");
			builder.put(grammarAccess.getScopeContextAccess().getGlobalAssignment_0_0(), "rule__ScopeContext__GlobalAssignment_0_0");
			builder.put(grammarAccess.getScopeContextAccess().getContextTypeAssignment_0_1(), "rule__ScopeContext__ContextTypeAssignment_0_1");
			builder.put(grammarAccess.getScopeContextAccess().getGuardAssignment_1_1(), "rule__ScopeContext__GuardAssignment_1_1");
			builder.put(grammarAccess.getFactoryExpressionAccess().getExprAssignment_1(), "rule__FactoryExpression__ExprAssignment_1");
			builder.put(grammarAccess.getScopeDelegationAccess().getDelegateAssignment_2_0(), "rule__ScopeDelegation__DelegateAssignment_2_0");
			builder.put(grammarAccess.getScopeDelegationAccess().getExternalAssignment_2_1(), "rule__ScopeDelegation__ExternalAssignment_2_1");
			builder.put(grammarAccess.getScopeDelegationAccess().getScopeAssignment_3_1(), "rule__ScopeDelegation__ScopeAssignment_3_1");
			builder.put(grammarAccess.getNamedScopeExpressionAccess().getCaseDefAssignment_1_0(), "rule__NamedScopeExpression__CaseDefAssignment_1_0");
			builder.put(grammarAccess.getNamedScopeExpressionAccess().getCasingAssignment_1_1(), "rule__NamedScopeExpression__CasingAssignment_1_1");
			builder.put(grammarAccess.getNamedScopeExpressionAccess().getNamingAssignment_2_1(), "rule__NamedScopeExpression__NamingAssignment_2_1");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getTypeAssignment_2(), "rule__GlobalScopeExpression__TypeAssignment_2");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getNameAssignment_3_0_3(), "rule__GlobalScopeExpression__NameAssignment_3_0_3");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getRecursivePrefixAssignment_3_1_1(), "rule__GlobalScopeExpression__RecursivePrefixAssignment_3_1_1");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getPrefixAssignment_3_1_4(), "rule__GlobalScopeExpression__PrefixAssignment_3_1_4");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getDataAssignment_4_4(), "rule__GlobalScopeExpression__DataAssignment_4_4");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getDataAssignment_4_5_1(), "rule__GlobalScopeExpression__DataAssignment_4_5_1");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getDomainsAssignment_5_3_0(), "rule__GlobalScopeExpression__DomainsAssignment_5_3_0");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getDomainsAssignment_5_3_1(), "rule__GlobalScopeExpression__DomainsAssignment_5_3_1");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getDomainsAssignment_5_3_2_1(), "rule__GlobalScopeExpression__DomainsAssignment_5_3_2_1");
			builder.put(grammarAccess.getGlobalScopeExpressionAccess().getDomainsAssignment_5_3_2_2_1(), "rule__GlobalScopeExpression__DomainsAssignment_5_3_2_2_1");
			builder.put(grammarAccess.getMatchDataExpressionAccess().getKeyAssignment_0(), "rule__MatchDataExpression__KeyAssignment_0");
			builder.put(grammarAccess.getMatchDataExpressionAccess().getValueAssignment_2(), "rule__MatchDataExpression__ValueAssignment_2");
			builder.put(grammarAccess.getLambdaDataExpressionAccess().getDescAssignment_1(), "rule__LambdaDataExpression__DescAssignment_1");
			builder.put(grammarAccess.getLambdaDataExpressionAccess().getValueAssignment_3(), "rule__LambdaDataExpression__ValueAssignment_3");
			builder.put(grammarAccess.getSimpleScopeExpressionAccess().getExprAssignment(), "rule__SimpleScopeExpression__ExprAssignment");
			builder.put(grammarAccess.getNamingAccess().getNamesAssignment_0_0_1(), "rule__Naming__NamesAssignment_0_0_1");
			builder.put(grammarAccess.getNamingAccess().getNamesAssignment_0_0_2_1(), "rule__Naming__NamesAssignment_0_0_2_1");
			builder.put(grammarAccess.getNamingAccess().getNamesAssignment_1(), "rule__Naming__NamesAssignment_1");
			builder.put(grammarAccess.getNamingExpressionAccess().getExportAssignment_0(), "rule__NamingExpression__ExportAssignment_0");
			builder.put(grammarAccess.getNamingExpressionAccess().getFactoryAssignment_1_0(), "rule__NamingExpression__FactoryAssignment_1_0");
			builder.put(grammarAccess.getNamingExpressionAccess().getExpressionAssignment_1_1(), "rule__NamingExpression__ExpressionAssignment_1_1");
	...
	@Override
	protected InternalScopeParser createParser() {
		InternalScopeParser result = new InternalScopeParser(null);
