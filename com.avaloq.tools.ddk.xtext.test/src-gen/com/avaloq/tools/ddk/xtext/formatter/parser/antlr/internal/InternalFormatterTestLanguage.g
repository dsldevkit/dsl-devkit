...
(
    ...
    { 
        $current = $this_TestColumn_4.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_TestOffset_5.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_TestRightPadding_6.current; 
        afterParserOrEnumRuleCall();
    }
))
;
...
// Entry rule entryRuleTestColumn
entryRuleTestColumn returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getTestColumnRule()); }
	 iv_ruleTestColumn=ruleTestColumn 
	 { $current=$iv_ruleTestColumn.current; } 
	 EOF 
;

// Rule TestColumn
ruleTestColumn returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
// Entry rule entryRuleTestOffset
entryRuleTestOffset returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getTestOffsetRule()); }
	 iv_ruleTestOffset=ruleTestOffset 
	 { $current=$iv_ruleTestOffset.current; } 
	 EOF 
;

// Rule TestOffset
ruleTestOffset returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
// Entry rule entryRuleTestRightPadding
entryRuleTestRightPadding returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getTestRightPaddingRule()); }
	 iv_ruleTestRightPadding=ruleTestRightPadding 
	 { $current=$iv_ruleTestRightPadding.current; } 
	 EOF 
;

// Rule TestRightPadding
ruleTestRightPadding returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='padding' 
