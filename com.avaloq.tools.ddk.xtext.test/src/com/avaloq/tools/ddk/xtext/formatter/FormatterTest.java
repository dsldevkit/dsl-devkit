...
public class FormatterTest extends AbstractFormatterTest {
   ...
   */
  @Test
  public void linewrap() throws Exception {
   ...
   */
  @Test
  public void keepComments() throws Exception {
    // String model = "test linewrap float val; int x; double y;";
   ...
   */
  @Test
  public void columnMinimumPadding() throws Exception {
   ...
   */
  @Test
  public void rightPadding() throws Exception {
   ...
   */
  @Test
  public void indentationAndComments() throws Exception {
   ...
   */
  @Test
  public void indentationAndLineWrap() throws Exception {
   ...
   */
  @Test
  public void between2() throws Exception {
    String model = "test indentation { indentation { x x; } }";
    String expected = "test indentation {\n	indentation {\n		x x;\n	}\n}";
    assertFormattedPTC(expected, model);
    assertFormattedNM(expected, model, 0, model.length());
   ...
   */
  @Test
  public void linewrapDatatypeRule() throws Exception {
   ...
   */
  @Test
  public void linewrapDatatypeRulePartial1() throws Exception {
   ...
   */
  @Test
  public void linewrapDatatypeRulePartial2() throws Exception {
   ...
   */
  @Test
  public void linewrapDatatypeRulePartial3() throws Exception {
    String model = "test linewrap fqn ab . xx .yy   .zz;fqn xxx;";
    String expected = "test linewrap fqn ab.xx.yy.zz;\nfqn xxx;";
   ...
   */
  @Test
  public void formatSegment1() throws Exception {
    String model = "test\nindentation {\n    indentation  {  x  x  ;  }  }";
    String expected = "test\nindentation {\n    indentation {\n    	x x;\n    }  }";
   ...
   */
  @Test
  public void formatSegment2() throws Exception {
   ...
   */
  @Test
  public void formatSegment3() throws Exception {
    String model = "     test       indentation {\n    indentation  {  x  x  ;  }  }";
    String expected = "test indentation {\n	indentation {\n		x x;\n	}\n}";
    assertFormattedNM(expected, model, 0, model.length());
  }
   ...
   */
  @Test
  public void linewrapDatatypeRuleRef1() throws Exception {
   ...
   */
  @Test
  public void linewrapDatatypeRuleRef2() throws Exception {
    String model = "test linewrap fqn ab.cd.ef; fqnref ab.cd.ef;";
    String expected = "test linewrap\nfqn\nab.cd.ef;\nfqnref\nab.cd.ef;";
    assertFormattedPTC(expected, model);
    assertFormattedNM(expected, model, 0, model.length());
   ...
   */
  @Test
  public void linewrapDatatypeRuleComments() throws Exception {
  ...
  @Test
  public void suppressedWhitespace() throws Exception {
  ...
  // would fail
  @Ignore
  public void suppressedLinewrap() throws Exception {
   ...
   */
  @Test
  public void linewrapMin() throws Exception {
   ...
   */
  @Test
  public void linewrapMax() throws Exception {
   ...
   */
  @Test
  public void linewrapKeep() throws Exception {
    String model = "test wrapminmax\n\n\n\nfoo bar;";
    assertFormattedPTC(model, model);
    assertFormattedNM(model, model, 0, model.length());
    assertPreserved(model);
   ...
   */
  @Test
  public void linewrapDefault() throws Exception {
   ...
   */
  @Test
  public void datatypeRules() throws Exception {
