...
public class HelloWorldPackageImpl extends EPackageImpl implements HelloWorldPackage
{
   ...
   * @see com.avaloq.tools.ddk.sample.helloworld.helloWorld.HelloWorldPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public static HelloWorldPackage init()
  {
    ...
    HelloWorldPackageImpl theHelloWorldPackage = (HelloWorldPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof HelloWorldPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new HelloWorldPackageImpl());
