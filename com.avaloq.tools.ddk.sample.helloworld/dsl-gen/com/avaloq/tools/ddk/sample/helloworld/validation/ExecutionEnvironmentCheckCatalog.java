...
public class ExecutionEnvironmentCheckCatalog extends AbstractIssue {
  ...
  public String getGreetingNameLength_DefaultName(final EObject context) {
    return checkConfigurationStoreService.getCheckConfigurationStore(context).getString("COM.AVALOQ.TOOLS.DDK.SAMPLE.HELLOWORLD.VALIDATION.EXECUTIONENVIRONMENTISSUECODES.GREETINGNAMELENGTH.DEFAULTNAME$PARAMETER", ExecutionEnvironmentPreferenceInitializer.GET_GREETING_NAME_LENGTH_DEFAULT_NAME_DEFAULT);
  }
  ...
  public SeverityKind getGreetingNameLengthSeverityKind(final EObject context) {
    final int result = checkConfigurationStoreService.getCheckConfigurationStore(context).getInt("COM.AVALOQ.TOOLS.DDK.SAMPLE.HELLOWORLD.VALIDATION.EXECUTIONENVIRONMENTISSUECODES.GREETINGNAMELENGTH$SEVERITY", 0);
