...
public class LibraryChecksCheckCatalog extends AbstractIssue {
  ...
  public SeverityKind getCheckCatalogIsActiveSeverityKind(final EObject context) {
    final int result = checkConfigurationStoreService.getCheckConfigurationStore(context).getInt("COM.AVALOQ.TOOLS.DDK.SAMPLE.HELLOWORLD.VALIDATION.LIBRARYCHECKSISSUECODES.CHECKCATALOGISACTIVE$SEVERITY", 1);
  ...
  public SeverityKind getCacheInjectionFailedSeverityKind(final EObject context) {
    final int result = checkConfigurationStoreService.getCheckConfigurationStore(context).getInt("COM.AVALOQ.TOOLS.DDK.SAMPLE.HELLOWORLD.VALIDATION.LIBRARYCHECKSISSUECODES.CACHEINJECTIONFAILED$SEVERITY", 0);
    return SeverityKind.values()[result];
  }
  ...
  public SeverityKind getCacheDoesntWorkSeverityKind(final EObject context) {
    final int result = checkConfigurationStoreService.getCheckConfigurationStore(context).getInt("COM.AVALOQ.TOOLS.DDK.SAMPLE.HELLOWORLD.VALIDATION.LIBRARYCHECKSISSUECODES.CACHEDOESNTWORK$SEVERITY", 0);
    return SeverityKind.values()[result];
  }
  ...
  public String getFormalParameters_Param1(final EObject context) {
    return checkConfigurationStoreService.getCheckConfigurationStore(context).getString("COM.AVALOQ.TOOLS.DDK.SAMPLE.HELLOWORLD.VALIDATION.LIBRARYCHECKSISSUECODES.FORMALPARAMETERS.PARAM1$PARAMETER", LibraryChecksPreferenceInitializer.GET_FORMAL_PARAMETERS_PARAM_1_DEFAULT);
  }
  ...
  public boolean getFormalParameters_Param2(final EObject context) {
    return checkConfigurationStoreService.getCheckConfigurationStore(context).getBoolean("COM.AVALOQ.TOOLS.DDK.SAMPLE.HELLOWORLD.VALIDATION.LIBRARYCHECKSISSUECODES.FORMALPARAMETERS.PARAM2$PARAMETER", LibraryChecksPreferenceInitializer.GET_FORMAL_PARAMETERS_PARAM_2_DEFAULT);
  }
  ...
  public Boolean getFormalParameters_Param3(final EObject context) {
    return checkConfigurationStoreService.getCheckConfigurationStore(context).getBoolean("COM.AVALOQ.TOOLS.DDK.SAMPLE.HELLOWORLD.VALIDATION.LIBRARYCHECKSISSUECODES.FORMALPARAMETERS.PARAM3$PARAMETER", LibraryChecksPreferenceInitializer.GET_FORMAL_PARAMETERS_PARAM_3_DEFAULT);
  }
  ...
  public List<String> getFormalParameters_Names(final EObject context) {
    return checkConfigurationStoreService.getCheckConfigurationStore(context).getStrings("COM.AVALOQ.TOOLS.DDK.SAMPLE.HELLOWORLD.VALIDATION.LIBRARYCHECKSISSUECODES.FORMALPARAMETERS.NAMES$PARAMETER", LibraryChecksPreferenceInitializer.GET_FORMAL_PARAMETERS_NAMES_DEFAULT);
  }
  ...
  public List<Integer> getFormalParameters_Ints(final EObject context) {
    return checkConfigurationStoreService.getCheckConfigurationStore(context).getIntegers("COM.AVALOQ.TOOLS.DDK.SAMPLE.HELLOWORLD.VALIDATION.LIBRARYCHECKSISSUECODES.FORMALPARAMETERS.INTS$PARAMETER", LibraryChecksPreferenceInitializer.GET_FORMAL_PARAMETERS_INTS_DEFAULT);
  }
  ...
  public SeverityKind getFormalParametersSeverityKind(final EObject context) {
    final int result = checkConfigurationStoreService.getCheckConfigurationStore(context).getInt("COM.AVALOQ.TOOLS.DDK.SAMPLE.HELLOWORLD.VALIDATION.LIBRARYCHECKSISSUECODES.FORMALPARAMETERS$SEVERITY", 0);
    return SeverityKind.values()[result];
  }
}
