...
class ScopeExpressionTranslator {
   ...
   * legacy {@code .ext} based resolution: the declaring type is named directly in the scope source rather than
  ...
  def ScopeTranslationContext newCompilationContext(String implicitVariableName, EClass implicitType,
    ...
    context.modelTypeResolver = ScopeModelTypeResolver.forElement(sourceElement)
   ...
   * linked to the resolved method, and finally an extension call to a {@code static} extension method (see I4).
