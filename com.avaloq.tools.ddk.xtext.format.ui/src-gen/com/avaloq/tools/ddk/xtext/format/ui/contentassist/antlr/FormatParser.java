 ...
 * generated by Xtext
 */
package com.avaloq.tools.ddk.xtext.format.ui.contentassist.antlr;
...
public class FormatParser extends AbstractContentAssistParser {
	...
	@Override
	protected com.avaloq.tools.ddk.xtext.format.ui.contentassist.antlr.internal.InternalFormatParser createParser() {
		com.avaloq.tools.ddk.xtext.format.ui.contentassist.antlr.internal.InternalFormatParser result = new com.avaloq.tools.ddk.xtext.format.ui.contentassist.antlr.internal.InternalFormatParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGrammarRuleAccess().getAlternatives_3(), "rule__GrammarRule__Alternatives_3");
					put(grammarAccess.getGrammarRuleDirectiveAccess().getAlternatives(), "rule__GrammarRuleDirective__Alternatives");
					put(grammarAccess.getWildcardRuleDirectiveAccess().getAlternatives(), "rule__WildcardRuleDirective__Alternatives");
					put(grammarAccess.getGrammarElementReferenceAccess().getAlternatives(), "rule__GrammarElementReference__Alternatives");
					put(grammarAccess.getGrammarElementLookupAccess().getAlternatives(), "rule__GrammarElementLookup__Alternatives");
					...
					put(grammarAccess.getLinewrapLocatorAccess().getAlternatives_0_1_1(), "rule__LinewrapLocator__Alternatives_0_1_1");
					put(grammarAccess.getColumnLocatorAccess().getAlternatives_2(), "rule__ColumnLocator__Alternatives_2");
					put(grammarAccess.getIndentLocatorAccess().getAlternatives_1(), "rule__IndentLocator__Alternatives_1");
					put(grammarAccess.getIndentLocatorAccess().getAlternatives_2(), "rule__IndentLocator__Alternatives_2");
					...
					put(grammarAccess.getMatcherTypeAccess().getAlternatives(), "rule__MatcherType__Alternatives");
					put(grammarAccess.getFormatConfigurationAccess().getGroup(), "rule__FormatConfiguration__Group__0");
					put(grammarAccess.getFormatConfigurationAccess().getGroup_3(), "rule__FormatConfiguration__Group_3__0");
					put(grammarAccess.getFormatConfigurationAccess().getGroup_4(), "rule__FormatConfiguration__Group_4__0");
					put(grammarAccess.getFormatConfigurationAccess().getGroup_5(), "rule__FormatConfiguration__Group_5__0");
					...
					put(grammarAccess.getWildcardRuleAccess().getGroup(), "rule__WildcardRule__Group__0");
					put(grammarAccess.getGrammarElementReferenceAccess().getGroup_0(), "rule__GrammarElementReference__Group_0__0");
					put(grammarAccess.getGrammarElementReferenceAccess().getGroup_1(), "rule__GrammarElementReference__Group_1__0");
					put(grammarAccess.getContextFreeDirectiveAccess().getGroup(), "rule__ContextFreeDirective__Group__0");
					put(grammarAccess.getContextFreeDirectiveAccess().getGroup_2(), "rule__ContextFreeDirective__Group_2__0");
					put(grammarAccess.getSpecificDirectiveAccess().getGroup(), "rule__SpecificDirective__Group__0");
					put(grammarAccess.getSpecificDirectiveAccess().getGroup_1(), "rule__SpecificDirective__Group_1__0");
					put(grammarAccess.getMatcherListAccess().getGroup(), "rule__MatcherList__Group__0");
					put(grammarAccess.getMatcherListAccess().getGroup_2(), "rule__MatcherList__Group_2__0");
					put(grammarAccess.getGroupBlockAccess().getGroup(), "rule__GroupBlock__Group__0");
					put(grammarAccess.getGroupBlockAccess().getGroup_2_1(), "rule__GroupBlock__Group_2_1__0");
					put(grammarAccess.getGroupBlockAccess().getGroup_2_2(), "rule__GroupBlock__Group_2_2__0");
					put(grammarAccess.getKeywordPairAccess().getGroup(), "rule__KeywordPair__Group__0");
					put(grammarAccess.getKeywordPairAccess().getGroup_5_0(), "rule__KeywordPair__Group_5_0__0");
					put(grammarAccess.getKeywordPairAccess().getGroup_5_1(), "rule__KeywordPair__Group_5_1__0");
					put(grammarAccess.getKeywordPairAccess().getGroup_6(), "rule__KeywordPair__Group_6__0");
					...
					put(grammarAccess.getLinewrapLocatorAccess().getGroup_0(), "rule__LinewrapLocator__Group_0__0");
					put(grammarAccess.getLinewrapLocatorAccess().getGroup_0_1(), "rule__LinewrapLocator__Group_0_1__0");
					put(grammarAccess.getLinewrapLocatorAccess().getGroup_0_1_1_1(), "rule__LinewrapLocator__Group_0_1_1_1__0");
					put(grammarAccess.getColumnLocatorAccess().getGroup(), "rule__ColumnLocator__Group__0");
					put(grammarAccess.getOffsetLocatorAccess().getGroup(), "rule__OffsetLocator__Group__0");
					put(grammarAccess.getIndentLocatorAccess().getGroup(), "rule__IndentLocator__Group__0");
					put(grammarAccess.getParameterizedIdentifierAccess().getGroup(), "rule__ParameterizedIdentifier__Group__0");
					put(grammarAccess.getParameterizedIdentifierAccess().getGroup_1(), "rule__ParameterizedIdentifier__Group_1__0");
					put(grammarAccess.getParameterizedStringAccess().getGroup(), "rule__ParameterizedString__Group__0");
					put(grammarAccess.getParameterizedStringAccess().getGroup_1(), "rule__ParameterizedString__Group_1__0");
					...
					put(grammarAccess.getFormatConfigurationAccess().getTargetGrammarAssignment_2(), "rule__FormatConfiguration__TargetGrammarAssignment_2");
					put(grammarAccess.getFormatConfigurationAccess().getExtendedFormatConfigurationAssignment_3_1(), "rule__FormatConfiguration__ExtendedFormatConfigurationAssignment_3_1");
					put(grammarAccess.getFormatConfigurationAccess().getFormatterBaseClassAssignment_4_1(), "rule__FormatConfiguration__FormatterBaseClassAssignment_4_1");
					put(grammarAccess.getFormatConfigurationAccess().getConstantsAssignment_5_1(), "rule__FormatConfiguration__ConstantsAssignment_5_1");
					put(grammarAccess.getFormatConfigurationAccess().getRulesAssignment_6(), "rule__FormatConfiguration__RulesAssignment_6");
					put(grammarAccess.getConstantAccess().getIntTypeAssignment_0_0(), "rule__Constant__IntTypeAssignment_0_0");
					put(grammarAccess.getConstantAccess().getStringTypeAssignment_0_1(), "rule__Constant__StringTypeAssignment_0_1");
					put(grammarAccess.getConstantAccess().getNameAssignment_1(), "rule__Constant__NameAssignment_1");
					put(grammarAccess.getConstantAccess().getIntValueAssignment_3_0(), "rule__Constant__IntValueAssignment_3_0");
					put(grammarAccess.getConstantAccess().getStringValueAssignment_3_1(), "rule__Constant__StringValueAssignment_3_1");
					put(grammarAccess.getIntValueAccess().getLiteralAssignment_0(), "rule__IntValue__LiteralAssignment_0");
					put(grammarAccess.getIntValueAccess().getReferenceAssignment_1(), "rule__IntValue__ReferenceAssignment_1");
					put(grammarAccess.getStringValueAccess().getLiteralAssignment_0(), "rule__StringValue__LiteralAssignment_0");
					put(grammarAccess.getStringValueAccess().getReferenceAssignment_1(), "rule__StringValue__ReferenceAssignment_1");
					put(grammarAccess.getGrammarRuleAccess().getOverrideAssignment_0(), "rule__GrammarRule__OverrideAssignment_0");
					put(grammarAccess.getGrammarRuleAccess().getTargetRuleAssignment_1(), "rule__GrammarRule__TargetRuleAssignment_1");
					put(grammarAccess.getGrammarRuleAccess().getDirectivesAssignment_3_0(), "rule__GrammarRule__DirectivesAssignment_3_0");
					put(grammarAccess.getGrammarRuleAccess().getDirectivesAssignment_3_1(), "rule__GrammarRule__DirectivesAssignment_3_1");
					put(grammarAccess.getWildcardRuleAccess().getOverrideAssignment_1(), "rule__WildcardRule__OverrideAssignment_1");
					put(grammarAccess.getWildcardRuleAccess().getDirectivesAssignment_4(), "rule__WildcardRule__DirectivesAssignment_4");
					put(grammarAccess.getGrammarElementReferenceAccess().getAssignmentAssignment_0_1(), "rule__GrammarElementReference__AssignmentAssignment_0_1");
					put(grammarAccess.getGrammarElementReferenceAccess().getRuleCallAssignment_1_1(), "rule__GrammarElementReference__RuleCallAssignment_1_1");
					put(grammarAccess.getGrammarElementReferenceAccess().getSelfAssignment_2(), "rule__GrammarElementReference__SelfAssignment_2");
					put(grammarAccess.getGrammarElementReferenceAccess().getRuleAssignment_3(), "rule__GrammarElementReference__RuleAssignment_3");
					put(grammarAccess.getGrammarElementReferenceAccess().getKeywordAssignment_4(), "rule__GrammarElementReference__KeywordAssignment_4");
					put(grammarAccess.getGrammarElementLookupAccess().getRuleAssignment_0(), "rule__GrammarElementLookup__RuleAssignment_0");
					put(grammarAccess.getGrammarElementLookupAccess().getKeywordAssignment_1(), "rule__GrammarElementLookup__KeywordAssignment_1");
					put(grammarAccess.getContextFreeDirectiveAccess().getGrammarElementsAssignment_1(), "rule__ContextFreeDirective__GrammarElementsAssignment_1");
					put(grammarAccess.getContextFreeDirectiveAccess().getGrammarElementsAssignment_2_1(), "rule__ContextFreeDirective__GrammarElementsAssignment_2_1");
					put(grammarAccess.getContextFreeDirectiveAccess().getMatcherListAssignment_4(), "rule__ContextFreeDirective__MatcherListAssignment_4");
					put(grammarAccess.getSpecificDirectiveAccess().getGrammarElementsAssignment_0(), "rule__SpecificDirective__GrammarElementsAssignment_0");
					put(grammarAccess.getSpecificDirectiveAccess().getGrammarElementsAssignment_1_1(), "rule__SpecificDirective__GrammarElementsAssignment_1_1");
					put(grammarAccess.getSpecificDirectiveAccess().getMatcherListAssignment_2(), "rule__SpecificDirective__MatcherListAssignment_2");
					put(grammarAccess.getMatcherListAccess().getMatchersAssignment_1(), "rule__MatcherList__MatchersAssignment_1");
					put(grammarAccess.getMatcherListAccess().getMatchersAssignment_2_1(), "rule__MatcherList__MatchersAssignment_2_1");
					put(grammarAccess.getGroupBlockAccess().getGrammarElementAssignment_1(), "rule__GroupBlock__GrammarElementAssignment_1");
					put(grammarAccess.getGroupBlockAccess().getMatcherListAssignment_2_0(), "rule__GroupBlock__MatcherListAssignment_2_0");
					put(grammarAccess.getGroupBlockAccess().getSubGroupAssignment_2_1_1(), "rule__GroupBlock__SubGroupAssignment_2_1_1");
					put(grammarAccess.getGroupBlockAccess().getDirectivesAssignment_2_2_1(), "rule__GroupBlock__DirectivesAssignment_2_2_1");
					put(grammarAccess.getKeywordPairAccess().getLeftAssignment_1(), "rule__KeywordPair__LeftAssignment_1");
					put(grammarAccess.getKeywordPairAccess().getRightAssignment_2(), "rule__KeywordPair__RightAssignment_2");
					put(grammarAccess.getKeywordPairAccess().getLeftMatchersAssignment_5_0_2(), "rule__KeywordPair__LeftMatchersAssignment_5_0_2");
					...
					put(grammarAccess.getLinewrapLocatorAccess().getValueAssignment_0_1_1_0(), "rule__LinewrapLocator__ValueAssignment_0_1_1_0");
					put(grammarAccess.getLinewrapLocatorAccess().getMinimumAssignment_0_1_1_1_0(), "rule__LinewrapLocator__MinimumAssignment_0_1_1_1_0");
					put(grammarAccess.getLinewrapLocatorAccess().getDefaultAssignment_0_1_1_1_1(), "rule__LinewrapLocator__DefaultAssignment_0_1_1_1_1");
					put(grammarAccess.getLinewrapLocatorAccess().getMaximumAssignment_0_1_1_1_2(), "rule__LinewrapLocator__MaximumAssignment_0_1_1_1_2");
					put(grammarAccess.getLinewrapLocatorAccess().getNoLinewrapAssignment_1(), "rule__LinewrapLocator__NoLinewrapAssignment_1");
					put(grammarAccess.getColumnLocatorAccess().getFixedAssignment_1(), "rule__ColumnLocator__FixedAssignment_1");
					put(grammarAccess.getColumnLocatorAccess().getValueAssignment_2_0(), "rule__ColumnLocator__ValueAssignment_2_0");
					put(grammarAccess.getColumnLocatorAccess().getParameterAssignment_2_1(), "rule__ColumnLocator__ParameterAssignment_2_1");
					put(grammarAccess.getColumnLocatorAccess().getRelativeAssignment_3(), "rule__ColumnLocator__RelativeAssignment_3");
					put(grammarAccess.getColumnLocatorAccess().getNobreakAssignment_4(), "rule__ColumnLocator__NobreakAssignment_4");
					put(grammarAccess.getOffsetLocatorAccess().getFixedAssignment_1(), "rule__OffsetLocator__FixedAssignment_1");
					put(grammarAccess.getOffsetLocatorAccess().getValueAssignment_2(), "rule__OffsetLocator__ValueAssignment_2");
					put(grammarAccess.getOffsetLocatorAccess().getNobreakAssignment_3(), "rule__OffsetLocator__NobreakAssignment_3");
					put(grammarAccess.getIndentLocatorAccess().getIncrementAssignment_1_0(), "rule__IndentLocator__IncrementAssignment_1_0");
					put(grammarAccess.getIndentLocatorAccess().getValueAssignment_2_0(), "rule__IndentLocator__ValueAssignment_2_0");
					put(grammarAccess.getIndentLocatorAccess().getParameterAssignment_2_1(), "rule__IndentLocator__ParameterAssignment_2_1");
