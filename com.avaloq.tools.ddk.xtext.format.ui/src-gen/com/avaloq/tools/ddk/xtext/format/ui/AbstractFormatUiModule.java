...
/**
 * Manual modifications go to {com.avaloq.tools.ddk.xtext.format.ui.FormatUiModule}
 */
@SuppressWarnings("all")
public abstract class AbstractFormatUiModule extends org.eclipse.xtext.xbase.annotations.ui.DefaultXbaseWithAnnotationsUiModule {
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.HIGHLIGHTING)).to(com.avaloq.tools.ddk.xtext.format.parser.antlr.internal.InternalFormatLexer.class);
	}
	...
	public Class<? extends org.eclipse.jface.viewers.ILabelProvider> bindILabelProvider() {
		return com.avaloq.tools.ddk.xtext.format.ui.labeling.FormatLabelProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.labeling.LabelProviderFragment
	public void configureResourceUIServiceLabelProvider(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.jface.viewers.ILabelProvider.class).annotatedWith(org.eclipse.xtext.ui.resource.ResourceServiceDescriptionLabelProvider.class).to(com.avaloq.tools.ddk.xtext.format.ui.labeling.FormatDescriptionLabelProvider.class);
	}

	// contributed by org.eclipse.xtext.ui.generator.outline.OutlineTreeProviderFragment
	public Class<? extends org.eclipse.xtext.ui.editor.outline.IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return com.avaloq.tools.ddk.xtext.format.ui.outline.FormatOutlineTreeProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.quickfix.IssueResolutionProvider> bindIssueResolutionProvider() {
		return com.avaloq.tools.ddk.xtext.format.ui.quickfix.FormatQuickfixProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.contentAssist.JavaBasedContentAssistFragment
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.IContentProposalProvider> bindIContentProposalProvider() {
		return com.avaloq.tools.ddk.xtext.format.ui.contentassist.FormatProposalProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return com.avaloq.tools.ddk.xtext.format.ui.contentassist.antlr.FormatParser.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(com.avaloq.tools.ddk.xtext.format.ui.contentassist.antlr.internal.InternalFormatLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(com.avaloq.tools.ddk.xtext.format.ui.contentassist.antlr.internal.InternalFormatLexer.class));
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.CONTENT_ASSIST)).to(com.avaloq.tools.ddk.xtext.format.ui.contentassist.antlr.internal.InternalFormatLexer.class);
	}
	...
	public void configureCompareViewerTitle(com.google.inject.Binder binder) {
		binder.bind(String.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Format Compare");
	}
