...
/**
 * Additional builder preferences for the Format DSL.
 */
public class FormatBuilderPreferenceAccess extends XbaseBuilderPreferenceAccess {

  /**
   * Preference identifier controlling whether the Format builder participant is disabled on a workspace build. As a boolean preference it defaults to
