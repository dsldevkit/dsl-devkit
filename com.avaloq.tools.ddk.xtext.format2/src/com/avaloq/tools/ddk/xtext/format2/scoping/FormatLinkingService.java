...
public class FormatLinkingService extends AbstractFastLinkingService {
  ...
  public List<EObject> getLinkedObjects(final EObject context, final EReference ref, final INode node) {
    ...
    if (ref == Format2Package.Literals.FORMAT_CONFIGURATION__TARGET_GRAMMAR) {
    ...
    } else if (ref == Format2Package.Literals.FORMAT_CONFIGURATION__EXTENDED_FORMAT_CONFIGURATION) {
    ...
    } else if ((ref == Format2Package.Literals.INT_VALUE__REFERENCE || ref == Format2Package.Literals.STRING_VALUE__REFERENCE)
    ...
    } else if (ref == Format2Package.Literals.RULE__OVERRIDE) {
