...
import com.avaloq.tools.ddk.xtext.format2.format2.GrammarElementReference;
...
public final class FormatGeneratorUtil {
  ...
  public static String getFormatterName(final FormatConfiguration format, final String classNamePrefix) {
    ...
    List<INode> nodes = NodeModelUtils.findNodesForFeature(format, Format2Package.Literals.FORMAT_CONFIGURATION__TARGET_GRAMMAR);
    if (nodes.isEmpty()) {
