...
import com.avaloq.tools.ddk.xtext.format2.naming.FormatScopeNameProvider
 ...
 */
class Format2ScopeProvider extends AbstractFormat2ScopeProvider {
  ...
  */
  ...
  def dispatch IScope scope(GrammarRule context, EReference reference) {
    if (reference == Format2Package.Literals::GRAMMAR_RULE__TARGET_RULE) {
    ...
    } else if (reference == Format2Package.Literals::GRAMMAR_ELEMENT_REFERENCE__ASSIGNMENT) {
      return createScopeForEObjects(scopeUtil.getAssignments(context.targetRule));
    } else if (reference == Format2Package.Literals::GRAMMAR_ELEMENT_REFERENCE__KEYWORD) {
      return createScopeForEObjects(scopeUtil.getKeywords(context.targetRule));
    } else if (reference == Format2Package.Literals::GRAMMAR_ELEMENT_REFERENCE__RULE_CALL) {
      return createScopeForEObjects(scopeUtil.getRuleCalls(context.targetRule));
    } else if (reference == Format2Package.Literals::GRAMMAR_ELEMENT_REFERENCE__SELF) {
  ...
  def dispatch IScope scope(GroupBlock context, EReference reference) {
    if (reference == Format2Package.Literals::GROUP_BLOCK__GRAMMAR_ELEMENT) {
  ...
  def dispatch IScope scope(GrammarElementReference context, EReference reference) {
    ...
    if (reference == Format2Package.Literals::GRAMMAR_ELEMENT_REFERENCE__KEYWORD) {
      if (groupBlock !== null) {
    ...
    } else if (reference == Format2Package.Literals::GRAMMAR_ELEMENT_REFERENCE__RULE) {
