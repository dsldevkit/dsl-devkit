 ...
 * </p>
 * <ul>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.ContextFreeDirectiveImpl#getGrammarElements <em>Grammar Elements</em>}</li>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.ContextFreeDirectiveImpl#getMatcherList <em>Matcher List</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContextFreeDirectiveImpl extends GrammarRuleDirectiveImpl implements ContextFreeDirective
{
  ...
  {
    return Format2Package.Literals.CONTEXT_FREE_DIRECTIVE;
  }
  ...
  public EList<GrammarElementLookup> getGrammarElements()
  {
    ...
    {
      grammarElements = new EObjectContainmentEList<GrammarElementLookup>(GrammarElementLookup.class, this, Format2Package.CONTEXT_FREE_DIRECTIVE__GRAMMAR_ELEMENTS);
    }
  ...
  public NotificationChain basicSetMatcherList(MatcherList newMatcherList, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Format2Package.CONTEXT_FREE_DIRECTIVE__MATCHER_LIST, oldMatcherList, newMatcherList);
  ...
  public void setMatcherList(MatcherList newMatcherList)
  {
    if (newMatcherList != matcherList)
    {
      ...
      if (matcherList != null)
        msgs = ((InternalEObject)matcherList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Format2Package.CONTEXT_FREE_DIRECTIVE__MATCHER_LIST, null, msgs);
      if (newMatcherList != null)
        msgs = ((InternalEObject)newMatcherList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Format2Package.CONTEXT_FREE_DIRECTIVE__MATCHER_LIST, null, msgs);
      msgs = basicSetMatcherList(newMatcherList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Format2Package.CONTEXT_FREE_DIRECTIVE__MATCHER_LIST, newMatcherList, newMatcherList));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Format2Package.CONTEXT_FREE_DIRECTIVE__GRAMMAR_ELEMENTS:
        return ((InternalEList<?>)getGrammarElements()).basicRemove(otherEnd, msgs);
      case Format2Package.CONTEXT_FREE_DIRECTIVE__MATCHER_LIST:
