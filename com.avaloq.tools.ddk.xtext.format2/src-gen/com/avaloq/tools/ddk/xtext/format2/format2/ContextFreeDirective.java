 ...
 * </p>
 * <ul>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.ContextFreeDirective#getGrammarElements <em>Grammar Elements</em>}</li>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.ContextFreeDirective#getMatcherList <em>Matcher List</em>}</li>
 * </ul>
 *
 * @see com.avaloq.tools.ddk.xtext.format2.format2.Format2Package#getContextFreeDirective()
 * @model
 * @generated
 */
public interface ContextFreeDirective extends GrammarRuleDirective, WildcardRuleDirective
{
   ...
   * The list contents are of type {@link com.avaloq.tools.ddk.xtext.format2.format2.GrammarElementLookup}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see com.avaloq.tools.ddk.xtext.format2.format2.Format2Package#getContextFreeDirective_GrammarElements()
   ...
   * @see com.avaloq.tools.ddk.xtext.format2.format2.Format2Package#getContextFreeDirective_MatcherList()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.avaloq.tools.ddk.xtext.format2.format2.ContextFreeDirective#getMatcherList <em>Matcher List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
