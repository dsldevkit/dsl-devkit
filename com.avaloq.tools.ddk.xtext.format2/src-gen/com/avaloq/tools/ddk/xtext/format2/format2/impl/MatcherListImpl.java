 ...
 * </p>
 * <ul>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.MatcherListImpl#getMatchers <em>Matchers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MatcherListImpl extends MinimalEObjectImpl.Container implements MatcherList
{
  ...
  {
    return Format2Package.Literals.MATCHER_LIST;
  }
  ...
  public EList<Matcher> getMatchers()
  {
    if (matchers == null)
    {
      matchers = new EObjectContainmentEList<Matcher>(Matcher.class, this, Format2Package.MATCHER_LIST__MATCHERS);
    }
    return matchers;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Format2Package.MATCHER_LIST__MATCHERS:
