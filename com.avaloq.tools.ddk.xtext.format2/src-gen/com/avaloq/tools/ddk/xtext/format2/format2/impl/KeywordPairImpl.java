 ...
 * </p>
 * <ul>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.KeywordPairImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.KeywordPairImpl#getRight <em>Right</em>}</li>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.KeywordPairImpl#getLeftMatchers <em>Left Matchers</em>}</li>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.KeywordPairImpl#getRightMatchers <em>Right Matchers</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KeywordPairImpl extends GrammarRuleDirectiveImpl implements KeywordPair
{
  ...
  {
    return Format2Package.Literals.KEYWORD_PAIR;
  }
  ...
  public void setLeft(String newLeft)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Format2Package.KEYWORD_PAIR__LEFT, oldLeft, left));
  }
  ...
  public void setRight(String newRight)
  {
    ...
    right = newRight;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Format2Package.KEYWORD_PAIR__RIGHT, oldRight, right));
  }
  ...
  public EList<Matcher> getLeftMatchers()
  {
    ...
    {
      leftMatchers = new EObjectContainmentEList<Matcher>(Matcher.class, this, Format2Package.KEYWORD_PAIR__LEFT_MATCHERS);
    }
    return leftMatchers;
  }
  ...
  public EList<Matcher> getRightMatchers()
  {
    ...
    {
      rightMatchers = new EObjectContainmentEList<Matcher>(Matcher.class, this, Format2Package.KEYWORD_PAIR__RIGHT_MATCHERS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Format2Package.KEYWORD_PAIR__LEFT_MATCHERS:
        return ((InternalEList<?>)getLeftMatchers()).basicRemove(otherEnd, msgs);
      case Format2Package.KEYWORD_PAIR__RIGHT_MATCHERS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Format2Package.KEYWORD_PAIR__LEFT:
        return getLeft();
      case Format2Package.KEYWORD_PAIR__RIGHT:
        return getRight();
      case Format2Package.KEYWORD_PAIR__LEFT_MATCHERS:
