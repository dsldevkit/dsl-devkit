 ...
 * @generated
 */
public class Format2Switch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case Format2Package.GRAMMAR_RULE_DIRECTIVE:
      {
      ...
      case Format2Package.WILDCARD_RULE_DIRECTIVE:
      {
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Format Configuration</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Format Configuration</em>'.
