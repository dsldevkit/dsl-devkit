 ...
 * </p>
 * <ul>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.SpecificDirective#getGrammarElements <em>Grammar Elements</em>}</li>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.SpecificDirective#getMatcherList <em>Matcher List</em>}</li>
 * </ul>
 *
 * @see com.avaloq.tools.ddk.xtext.format2.format2.Format2Package#getSpecificDirective()
 * @model
 * @generated
 */
public interface SpecificDirective extends GrammarRuleDirective
{
   ...
   * The list contents are of type {@link com.avaloq.tools.ddk.xtext.format2.format2.GrammarElementReference}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see com.avaloq.tools.ddk.xtext.format2.format2.Format2Package#getSpecificDirective_GrammarElements()
   ...
   * @see com.avaloq.tools.ddk.xtext.format2.format2.Format2Package#getSpecificDirective_MatcherList()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.avaloq.tools.ddk.xtext.format2.format2.SpecificDirective#getMatcherList <em>Matcher List</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
