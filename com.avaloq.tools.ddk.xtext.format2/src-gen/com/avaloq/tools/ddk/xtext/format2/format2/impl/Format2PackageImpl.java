...
import com.avaloq.tools.ddk.xtext.format2.format2.ColumnLocator;
...
import com.avaloq.tools.ddk.xtext.format2.format2.Format2Factory;
...
import com.avaloq.tools.ddk.xtext.format2.format2.IndentLocator;
...
import com.avaloq.tools.ddk.xtext.format2.format2.OffsetLocator;
import com.avaloq.tools.ddk.xtext.format2.format2.RightPaddingLocator;
import com.avaloq.tools.ddk.xtext.format2.format2.Rule;
import com.avaloq.tools.ddk.xtext.format2.format2.SpaceLocator;
 ...
 * @generated
 */
public class Format2PackageImpl extends EPackageImpl implements Format2Package
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.avaloq.tools.ddk.xtext.format2.format2.Format2Package#eNS_URI
   * @see #init()
   * @generated
   */
  private Format2PackageImpl()
  {
    super(eNS_URI, Format2Factory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link Format2Package#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static Format2Package init()
  {
    if (isInited) return (Format2Package)EPackage.Registry.INSTANCE.getEPackage(Format2Package.eNS_URI);

    // Obtain or create and register package
    Format2PackageImpl theFormat2Package = (Format2PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Format2PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Format2PackageImpl());
    ...
    theFormat2Package.createPackageContents();

    // Initialize created meta-data
    theFormat2Package.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theFormat2Package.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(Format2Package.eNS_URI, theFormat2Package);
    return theFormat2Package;
  }
   ...
   * @generated
   */
  public Format2Factory getFormat2Factory()
  {
    return (Format2Factory)getEFactoryInstance();
  }
