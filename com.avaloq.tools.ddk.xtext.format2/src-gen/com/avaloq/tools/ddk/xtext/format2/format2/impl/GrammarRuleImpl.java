 ...
 * </p>
 * <ul>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.GrammarRuleImpl#getTargetRule <em>Target Rule</em>}</li>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.GrammarRuleImpl#getDirectives <em>Directives</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GrammarRuleImpl extends RuleImpl implements GrammarRule
{
  ...
  {
    return Format2Package.Literals.GRAMMAR_RULE;
  }
    ...
    if (targetRule != null && targetRule.eIsProxy())
    {
      ...
      if (targetRule != oldTargetRule)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, Format2Package.GRAMMAR_RULE__TARGET_RULE, oldTargetRule, targetRule));
      }
    }
    return targetRule;
  }
  ...
  public void setTargetRule(AbstractRule newTargetRule)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Format2Package.GRAMMAR_RULE__TARGET_RULE, oldTargetRule, targetRule));
  }
  ...
  public EList<EObject> getDirectives()
  {
    if (directives == null)
    {
      directives = new EObjectContainmentEList<EObject>(EObject.class, this, Format2Package.GRAMMAR_RULE__DIRECTIVES);
    }
    return directives;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Format2Package.GRAMMAR_RULE__DIRECTIVES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Format2Package.GRAMMAR_RULE__TARGET_RULE:
