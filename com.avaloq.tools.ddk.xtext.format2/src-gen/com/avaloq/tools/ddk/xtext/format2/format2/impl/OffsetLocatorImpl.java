 ...
 * </p>
 * <ul>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.OffsetLocatorImpl#isFixed <em>Fixed</em>}</li>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.OffsetLocatorImpl#getValue <em>Value</em>}</li>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.OffsetLocatorImpl#isNobreak <em>Nobreak</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OffsetLocatorImpl extends LocatorImpl implements OffsetLocator
{
  ...
  {
    return Format2Package.Literals.OFFSET_LOCATOR;
  }
  ...
  public void setFixed(boolean newFixed)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Format2Package.OFFSET_LOCATOR__FIXED, oldFixed, fixed));
  }
  ...
  public NotificationChain basicSetValue(IntValue newValue, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Format2Package.OFFSET_LOCATOR__VALUE, oldValue, newValue);
  ...
  public void setValue(IntValue newValue)
  {
    if (newValue != value)
    {
      ...
      if (value != null)
        msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Format2Package.OFFSET_LOCATOR__VALUE, null, msgs);
      if (newValue != null)
        msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Format2Package.OFFSET_LOCATOR__VALUE, null, msgs);
      msgs = basicSetValue(newValue, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Format2Package.OFFSET_LOCATOR__VALUE, newValue, newValue));
  }
  ...
  public void setNobreak(boolean newNobreak)
  {
    ...
    nobreak = newNobreak;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Format2Package.OFFSET_LOCATOR__NOBREAK, oldNobreak, nobreak));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Format2Package.OFFSET_LOCATOR__VALUE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Format2Package.OFFSET_LOCATOR__FIXED:
        return isFixed();
      case Format2Package.OFFSET_LOCATOR__VALUE:
        return getValue();
      case Format2Package.OFFSET_LOCATOR__NOBREAK:
        return isNobreak();
    }
