...
public abstract class AbstractFormat2SemanticSequencer extends XbaseWithAnnotationsSemanticSequencer {
	...
	protected void sequence_RightPaddingLocator(ISerializationContext context, RightPaddingLocator semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, Format2Package.Literals.RIGHT_PADDING_LOCATOR__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, Format2Package.Literals.RIGHT_PADDING_LOCATOR__VALUE));
		}
