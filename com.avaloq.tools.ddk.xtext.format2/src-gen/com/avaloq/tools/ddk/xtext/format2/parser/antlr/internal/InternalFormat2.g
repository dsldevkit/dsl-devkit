...
@parser::members {
    ...
    public InternalFormat2Parser(TokenStream input, Format2GrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected Format2GrammarAccess getGrammarAccess() {
				...
				(
					...
					lv_constants_8_0=ruleConstant
					{
						...
						add(
							...
							"constants",
							lv_constants_8_0,
							"com.avaloq.tools.ddk.xtext.format2.Format2.Constant");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_rules_10_0=ruleRule
				{
					...
					add(
						...
						"rules",
						lv_rules_10_0,
						"com.avaloq.tools.ddk.xtext.format2.Format2.Rule");
					afterParserOrEnumRuleCall();
				}
			)
		)*
				...
				(
					...
					lv_intValue_4_0=ruleIntObject
					{
						...
						set(
							...
							"intValue",
							lv_intValue_4_0,
							"com.avaloq.tools.ddk.xtext.format2.Format2.IntObject");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_directives_3_0=ruleGrammarRuleDirective
					{
						...
						add(
							...
							"directives",
							lv_directives_3_0,
							"com.avaloq.tools.ddk.xtext.format2.Format2.GrammarRuleDirective");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_directives_4_0=ruleGroupBlock
					{
						...
						add(
							...
							"directives",
							lv_directives_4_0,
							"com.avaloq.tools.ddk.xtext.format2.Format2.GroupBlock");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_directives_4_0=ruleWildcardRuleDirective
				{
					...
					add(
						...
						"directives",
						lv_directives_4_0,
						"com.avaloq.tools.ddk.xtext.format2.Format2.WildcardRuleDirective");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_grammarElements_1_0=ruleGrammarElementLookup
				{
					...
					add(
						...
						"com.avaloq.tools.ddk.xtext.format2.Format2.GrammarElementLookup");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_matcherList_5_0=ruleMatcherList
				{
					...
					set(
						...
						"matcherList",
						lv_matcherList_5_0,
						"com.avaloq.tools.ddk.xtext.format2.Format2.MatcherList");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_grammarElements_0_0=ruleGrammarElementReference
				{
					...
					add(
						...
						"com.avaloq.tools.ddk.xtext.format2.Format2.GrammarElementReference");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_matchers_1_0=ruleMatcher
				{
					...
					add(
						...
						"matchers",
						lv_matchers_1_0,
						"com.avaloq.tools.ddk.xtext.format2.Format2.Matcher");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_locator_0_0=ruleLocator
				{
					...
					set(
						...
						"locator",
						lv_locator_0_0,
						"com.avaloq.tools.ddk.xtext.format2.Format2.Locator");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_type_1_0=ruleMatcherType
				{
					...
					set(
						...
						"type",
						lv_type_1_0,
						"com.avaloq.tools.ddk.xtext.format2.Format2.MatcherType");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_value_1_0=ruleStringValue
					{
						...
						set(
							...
							"value",
							lv_value_1_0,
							"com.avaloq.tools.ddk.xtext.format2.Format2.StringValue");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_value_1_0=ruleIntValue
				{
					...
					set(
						...
						"value",
						lv_value_1_0,
						"com.avaloq.tools.ddk.xtext.format2.Format2.IntValue");
					afterParserOrEnumRuleCall();
				}
			)
		)
						...
						(
							...
							lv_name_4_0=ruleValidID
							{
								...
								set(
									...
									"name",
									lv_name_4_0,
									"com.avaloq.tools.ddk.xtext.format2.Format2.ValidID");
								afterParserOrEnumRuleCall();
							}
						)
					)
