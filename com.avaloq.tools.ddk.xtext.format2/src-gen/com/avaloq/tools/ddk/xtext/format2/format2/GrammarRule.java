 ...
 * </p>
 * <ul>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.GrammarRule#getTargetRule <em>Target Rule</em>}</li>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.GrammarRule#getDirectives <em>Directives</em>}</li>
 * </ul>
 *
 * @see com.avaloq.tools.ddk.xtext.format2.format2.Format2Package#getGrammarRule()
 * @model
 * @generated
 */
public interface GrammarRule extends Rule
{
   ...
   * @see com.avaloq.tools.ddk.xtext.format2.format2.Format2Package#getGrammarRule_TargetRule()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link com.avaloq.tools.ddk.xtext.format2.format2.GrammarRule#getTargetRule <em>Target Rule</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.avaloq.tools.ddk.xtext.format2.format2.Format2Package#getGrammarRule_Directives()
