 ...
 * </p>
 * <ul>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.ConstantImpl#isIntType <em>Int Type</em>}</li>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.ConstantImpl#isStringType <em>String Type</em>}</li>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.ConstantImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.ConstantImpl#getIntValue <em>Int Value</em>}</li>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.ConstantImpl#getStringValue <em>String Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConstantImpl extends MinimalEObjectImpl.Container implements Constant
{
  ...
  {
    return Format2Package.Literals.CONSTANT;
  }
  ...
  public void setIntType(boolean newIntType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Format2Package.CONSTANT__INT_TYPE, oldIntType, intType));
  }
  ...
  public void setStringType(boolean newStringType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Format2Package.CONSTANT__STRING_TYPE, oldStringType, stringType));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Format2Package.CONSTANT__NAME, oldName, name));
  }
  ...
  public void setIntValue(Integer newIntValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Format2Package.CONSTANT__INT_VALUE, oldIntValue, intValue));
  }
  ...
  public void setStringValue(String newStringValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Format2Package.CONSTANT__STRING_VALUE, oldStringValue, stringValue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Format2Package.CONSTANT__INT_TYPE:
        return isIntType();
      case Format2Package.CONSTANT__STRING_TYPE:
        return isStringType();
      case Format2Package.CONSTANT__NAME:
        return getName();
      case Format2Package.CONSTANT__INT_VALUE:
        return getIntValue();
      case Format2Package.CONSTANT__STRING_VALUE:
