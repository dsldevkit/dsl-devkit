...
import com.avaloq.tools.ddk.xtext.format2.format2.MatcherList;
 ...
 * </p>
 * <ul>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.GroupBlockImpl#getGrammarElement <em>Grammar Element</em>}</li>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.GroupBlockImpl#getMatcherList <em>Matcher List</em>}</li>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.GroupBlockImpl#getSubGroup <em>Sub Group</em>}</li>
 *   <li>{@link com.avaloq.tools.ddk.xtext.format2.format2.impl.GroupBlockImpl#getDirectives <em>Directives</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GroupBlockImpl extends MinimalEObjectImpl.Container implements GroupBlock
{
  ...
  {
    return Format2Package.Literals.GROUP_BLOCK;
  }
    ...
    if (grammarElement != null && grammarElement.eIsProxy())
    {
      ...
      if (grammarElement != oldGrammarElement)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, Format2Package.GROUP_BLOCK__GRAMMAR_ELEMENT, oldGrammarElement, grammarElement));
      }
    }
  ...
  public void setGrammarElement(CompoundElement newGrammarElement)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Format2Package.GROUP_BLOCK__GRAMMAR_ELEMENT, oldGrammarElement, grammarElement));
  }
  ...
  public NotificationChain basicSetMatcherList(MatcherList newMatcherList, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Format2Package.GROUP_BLOCK__MATCHER_LIST, oldMatcherList, newMatcherList);
  ...
  public void setMatcherList(MatcherList newMatcherList)
  {
    if (newMatcherList != matcherList)
    {
      ...
      if (matcherList != null)
        msgs = ((InternalEObject)matcherList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Format2Package.GROUP_BLOCK__MATCHER_LIST, null, msgs);
      if (newMatcherList != null)
        msgs = ((InternalEObject)newMatcherList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Format2Package.GROUP_BLOCK__MATCHER_LIST, null, msgs);
      msgs = basicSetMatcherList(newMatcherList, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Format2Package.GROUP_BLOCK__MATCHER_LIST, newMatcherList, newMatcherList));
  }
  ...
  public NotificationChain basicSetSubGroup(GroupBlock newSubGroup, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Format2Package.GROUP_BLOCK__SUB_GROUP, oldSubGroup, newSubGroup);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setSubGroup(GroupBlock newSubGroup)
  {
    if (newSubGroup != subGroup)
    {
      NotificationChain msgs = null;
      if (subGroup != null)
        msgs = ((InternalEObject)subGroup).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Format2Package.GROUP_BLOCK__SUB_GROUP, null, msgs);
      if (newSubGroup != null)
        msgs = ((InternalEObject)newSubGroup).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Format2Package.GROUP_BLOCK__SUB_GROUP, null, msgs);
      msgs = basicSetSubGroup(newSubGroup, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Format2Package.GROUP_BLOCK__SUB_GROUP, newSubGroup, newSubGroup));
  }
  ...
  public EList<GrammarRuleDirective> getDirectives()
  {
    if (directives == null)
    {
      directives = new EObjectContainmentEList<GrammarRuleDirective>(GrammarRuleDirective.class, this, Format2Package.GROUP_BLOCK__DIRECTIVES);
    }
    return directives;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Format2Package.GROUP_BLOCK__MATCHER_LIST:
        return basicSetMatcherList(null, msgs);
      case Format2Package.GROUP_BLOCK__SUB_GROUP:
        return basicSetSubGroup(null, msgs);
      case Format2Package.GROUP_BLOCK__DIRECTIVES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Format2Package.GROUP_BLOCK__GRAMMAR_ELEMENT:
