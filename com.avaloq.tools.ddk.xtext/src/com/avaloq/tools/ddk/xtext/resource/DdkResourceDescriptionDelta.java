...
public class DdkResourceDescriptionDelta implements Delta {

  /** Class-wide logger. */
  private static final Logger LOGGER = Logger.getLogger(DdkResourceDescriptionDelta.class);
   ...
   *          index
   */
  public DdkResourceDescriptionDelta(final IResourceDescription oldDesc, final IResourceDescription newDesc, final IResourceDescriptions index) {
    super();
    if (oldDesc == newDesc) {
