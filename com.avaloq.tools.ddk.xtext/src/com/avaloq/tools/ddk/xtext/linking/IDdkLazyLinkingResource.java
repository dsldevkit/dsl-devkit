 ...
 */
public interface IDdkLazyLinkingResource extends Resource, Resource.Internal {

  String MARK_UNRESOLVABLE_XREFS = IDdkLazyLinkingResource.class.getName() + ".MARK_UNRESOLVABLE_XREFS"; //$NON-NLS-1$
