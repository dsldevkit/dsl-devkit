...
public class DdkLazyLinkingResource extends DerivedStateAwareResource implements IDdkLazyLinkingResource {

  /** Class-wide logger. */
  private static final Logger LOGGER = Logger.getLogger(DdkLazyLinkingResource.class);
   ...
   */
  public static final String MARK_UNRESOLVABLE_XREFS = IDdkLazyLinkingResource.MARK_UNRESOLVABLE_XREFS;

  /**
   * Global key to store a flag in the resource scope cache whether lazy linking has been done.
   */
  private static final String LAZY_CROSS_REFERENCES_RESOLVED = IDdkLazyLinkingResource.class.getName() + ".LAZY_CROSS_REFERENCES_RESOLVED"; //$NON-NLS-1$
  ...
  public synchronized EObject getEObject(final String uriFragment) {
    try {
      ...
      return result;
    } catch (DdkLazyURIEncoder.DecodingError err) {
