...
public class ParameterizedConditionalIndentationEndLocator extends IndentationLocatorEndFacade implements IParametrizedLocator, IConditionalLocator {
  ...
  public ParameterizedConditionalIndentationEndLocator(final ExtendedFormattingConfig formattingConfig, final LocatorParameterCalculator<?> calculator, final LocatorActivator<?> locatorActivator) {
  ...
  @SuppressWarnings("PMD.UnusedFormalParameter")
  public ParameterizedConditionalIndentationEndLocator(final ExtendedFormattingConfig formattingConfig, final AbstractElement ele, final LocatorParameterCalculator<?> calculator, final LocatorActivator<?> locatorActivator) {
