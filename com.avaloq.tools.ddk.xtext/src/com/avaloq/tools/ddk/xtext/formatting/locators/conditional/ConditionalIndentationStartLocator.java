...
public class ConditionalIndentationStartLocator extends IndentationLocatorStartFacade implements IConditionalLocator {
  ...
  public ConditionalIndentationStartLocator(final ExtendedFormattingConfig formattingConfig, final LocatorActivator<?> locatorActivator) {
    super(formattingConfig);
    this.locatorActivator = locatorActivator;
  }

  @SuppressWarnings("PMD.UnusedFormalParameter")
  public ConditionalIndentationStartLocator(final ExtendedFormattingConfig formattingConfig, final AbstractElement ele, final LocatorActivator<?> locatorActivator) {
    super(formattingConfig, ele);
    this.locatorActivator = locatorActivator;
  }

  @SuppressWarnings("PMD.UnusedFormalParameter")
  public ConditionalIndentationStartLocator(final ExtendedFormattingConfig formattingConfig, final LocatorActivator<?> locatorActivator, final int indentation) {
    super(formattingConfig, indentation);
    this.locatorActivator = locatorActivator;
  }

  @SuppressWarnings("PMD.UnusedFormalParameter")
  public ConditionalIndentationStartLocator(final ExtendedFormattingConfig formattingConfig, final AbstractElement ele, final LocatorActivator<?> locatorActivator, final int indentation) {
