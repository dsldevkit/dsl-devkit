...
/**
 * The class DdkFormattingConfigBasedStream extends {@link org.eclipse.xtext.formatting.impl.FormattingConfigBasedStream} to
 * replace its inner classes Line and LineEntry to give support for more locators. Those include RightPaddingLocator
 * and ColumnLocator.
 */
public class DdkFormattingConfigBasedStream extends FormattingConfigBasedStream implements IDelegatingTokenStream {

  private static final Logger LOGGER = Logger.getLogger(DdkFormattingConfigBasedStream.class);
  ...
  private final AbstractDdkFormatter formatter;
  ...
  // @Format-Off
  public DdkFormattingConfigBasedStream(final ITokenStream out, final String indentation, final FormattingConfig cfg, final IElementMatcher<ElementPattern> matcher,
                                        final IHiddenTokenHelper hiddenTokenHelper, final boolean preserveSpaces, final AbstractDdkFormatter formatter) {
  // @Format-On
  ...
  public LineEntry createLineEntry(final EObject grammarElement, final String value, final boolean isHidden, final Set<ElementLocator> beforeLocators, final String leadingWS, final int indent, final ParserRule hiddenTokenDefition) {
    ...
    DdkLineEntry lineEntry = new DdkLineEntry(this, grammarElement, newValue, isHidden, activeLocators, newLeadingWS, indent, hiddenTokenDefition);
  ...
  /**
   * This class extends LineEntry in order to make some of its methods public and allow its extension by DdkLineEntry.
   */
  public abstract class AbstractDdkLineEntry extends LineEntry {
    public AbstractDdkLineEntry(final EObject grammarElement, final String value, final boolean isHidden, final Set<ElementLocator> beforeLocators, final String leadingWS, final int indent, final ParserRule hiddenTokenDefinition) {
  ...
  /**
   * This class extends Line in order to support handling of DdkLineEntry elements.
   */
  public abstract class AbstractDdkLine extends Line {

    @Override
    public final Line add(final LineEntry lineEntry) throws IOException {
      return addEntry((DdkLineEntry) lineEntry);
    }

    /**
     * Add an {@link DdkLineEntry} to this line.
     ...
     * @return {@link DdkLine} - the current line
     * @throws IOException
     *           - the exception propagated from the underlying {@link ITokenStream}
     */
    public abstract DdkLine addEntry(final DdkLineEntry lineEntry) throws IOException;
