...
/**
 * The Class AcfFormattingConfig extends {@link FormattingConfig2} in order to introduce {@link NoFormatLocator}, custom {@link IndentationLocatorEnd}
...
public class ExtendedFormattingConfig extends FormattingConfig2 {
  ...
  public int getDefaultIndentation() {
    return ((IIndentationInformationWithDefaults) indentInfo).getDefaultIndentation();
  }
   ...
   * @return new conditional indentation end locator
   */
  public IndentationLocatorEnd setIndentationDecrement(final int indentation, final LocatorActivator<?> locatorActivator) {
