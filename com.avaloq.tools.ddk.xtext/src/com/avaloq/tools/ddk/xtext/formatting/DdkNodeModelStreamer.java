...
public class DdkNodeModelStreamer extends NodeModelStreamer {
  ...
  protected void writeSemantic(final ITokenStream out, final ICompositeNode node) throws IOException {
    ...
    if (out instanceof DdkFormattingConfigBasedStream) {
      ((DdkFormattingConfigBasedStream) out).setNode(node);
    }
