...
/**
 * Parameterized indentation end locator face.
 *
...
public class ParameterizedIndentationEndLocator extends IndentationLocatorEndFacade implements IParametrizedLocator {
  ...
  public ParameterizedIndentationEndLocator(final ExtendedFormattingConfig formattingConfig, final LocatorParameterCalculator<?> calculator) {
    super(formattingConfig);
    this.calculator = calculator;
  }

  @SuppressWarnings("PMD.UnusedFormalParameter")
  public ParameterizedIndentationEndLocator(final ExtendedFormattingConfig formattingConfig, final AbstractElement ele, final LocatorParameterCalculator<?> calculator) {
