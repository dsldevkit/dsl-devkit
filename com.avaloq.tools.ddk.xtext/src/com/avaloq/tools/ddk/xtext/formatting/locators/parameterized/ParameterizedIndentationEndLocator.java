...
public class ParameterizedIndentationEndLocator extends IndentationLocatorEndFacade implements IParametrizedLocator {
  ...
  public ParameterizedIndentationEndLocator(final DdkFormattingConfig formattingConfig, final LocatorParameterCalculator<?> calculator) {
    super(formattingConfig);
    this.calculator = calculator;
  }

  @SuppressWarnings("PMD.UnusedFormalParameter")
  public ParameterizedIndentationEndLocator(final DdkFormattingConfig formattingConfig, final AbstractElement ele, final LocatorParameterCalculator<?> calculator) {
