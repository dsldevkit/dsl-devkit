...
public class ModelInferenceAdapterFactory extends AdapterFactoryImpl
{
	 ...
	 * @generated
	 */
	protected ModelInferenceSwitch<Adapter> modelSwitch =
		new ModelInferenceSwitch<Adapter>()
		{
			@Override
			public Adapter caseInferenceContainer(InferenceContainer object)
			{
				return createInferenceContainerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.avaloq.tools.ddk.xtext.modelinference.InferenceContainer <em>Inference Container</em>}'.
	 * <!-- begin-user-doc -->
