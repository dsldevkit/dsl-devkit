 ...
 */
package com.avaloq.tools.ddk.xtext.format2.ide.contentassist.antlr;

import com.avaloq.tools.ddk.xtext.format2.ide.contentassist.antlr.internal.InternalFormat2Parser;
...
public class Format2Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(Format2GrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, Format2GrammarAccess grammarAccess) {
	...
	@Override
	protected InternalFormat2Parser createParser() {
		InternalFormat2Parser result = new InternalFormat2Parser(null);
