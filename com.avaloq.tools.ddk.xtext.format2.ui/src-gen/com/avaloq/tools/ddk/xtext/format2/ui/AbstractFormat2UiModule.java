...
import com.avaloq.tools.ddk.xtext.format2.ide.contentassist.antlr.PartialFormat2ContentAssistParser;
import com.avaloq.tools.ddk.xtext.format2.ide.contentassist.antlr.internal.InternalFormat2Lexer;
import com.avaloq.tools.ddk.xtext.format2.ui.contentassist.Format2ProposalProvider;
import com.avaloq.tools.ddk.xtext.format2.ui.editor.Format2Editor;
import com.avaloq.tools.ddk.xtext.format2.ui.labeling.Format2DescriptionLabelProvider;
import com.avaloq.tools.ddk.xtext.format2.ui.labeling.Format2LabelProvider;
import com.avaloq.tools.ddk.xtext.format2.ui.outline.Format2OutlineTreeProvider;
import com.avaloq.tools.ddk.xtext.format2.ui.quickfix.Format2QuickfixProvider;
import com.avaloq.tools.ddk.xtext.format2.validation.Format2ValidatorConfigurationBlock;
...
/**
 * Manual modifications go to {@link Format2UiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractFormat2UiModule extends DefaultXbaseWithAnnotationsUiModule {

	public AbstractFormat2UiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(com.avaloq.tools.ddk.xtext.format2.parser.antlr.internal.InternalFormat2Lexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalFormat2Lexer.class).toProvider(LexerProvider.create(InternalFormat2Lexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return Format2ValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return Format2LabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(Format2DescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return Format2OutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return Format2QuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return Format2ProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialFormat2ContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Format2 Compare");
	}
