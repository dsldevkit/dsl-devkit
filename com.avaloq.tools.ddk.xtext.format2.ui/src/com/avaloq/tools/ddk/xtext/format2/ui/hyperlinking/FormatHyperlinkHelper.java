 ...
 *******************************************************************************/
package com.avaloq.tools.ddk.xtext.format2.ui.hyperlinking;
...
public class FormatHyperlinkHelper extends HyperlinkHelper {
  ...
  private boolean isOverrideKeyword(final EObject grammarElement) {
    Keyword override1 = ((Format2GrammarAccess) grammarAccess).getWildcardRuleAccess().getOverrideOverrideKeyword_1_0();
    Keyword override2 = ((Format2GrammarAccess) grammarAccess).getGrammarRuleAccess().getOverrideOverrideKeyword_0_0();
