...
entryRuleCheckConfiguration returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getCheckConfigurationRule()); }
	iv_ruleCheckConfiguration=ruleCheckConfiguration
	{ $current=$iv_ruleCheckConfiguration.current; }
	EOF;

// Rule CheckConfiguration
ruleCheckConfiguration returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleConfiguredLanguageValidator returns [EObject current=null]:
	...
	{ $current=$iv_ruleConfiguredLanguageValidator.current; }
	EOF;

// Rule ConfiguredLanguageValidator
ruleConfiguredLanguageValidator returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleConfiguredCatalog returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getConfiguredCatalogRule()); }
	iv_ruleConfiguredCatalog=ruleConfiguredCatalog
	{ $current=$iv_ruleConfiguredCatalog.current; }
	EOF;

// Rule ConfiguredCatalog
ruleConfiguredCatalog returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleConfiguredCheck returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getConfiguredCheckRule()); }
	iv_ruleConfiguredCheck=ruleConfiguredCheck
	{ $current=$iv_ruleConfiguredCheck.current; }
	EOF;

// Rule ConfiguredCheck
ruleConfiguredCheck returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleConfiguredParameter returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getConfiguredParameterRule()); }
	iv_ruleConfiguredParameter=ruleConfiguredParameter
	{ $current=$iv_ruleConfiguredParameter.current; }
	EOF;

// Rule ConfiguredParameter
ruleConfiguredParameter returns [EObject current=null]
@init {
	enterRule();
}
@after {
