...
public class ExecutionEnvironmentPreferenceInitializer extends AbstractPreferenceInitializer {
  ...
  private void initializeSeverities(final IEclipsePreferences preferences) {
    preferences.putInt("COM.AVALOQ.TOOLS.DDK.CHECK.VALIDATION.EXECUTIONENVIRONMENTISSUECODES.GREETINGNAMELENGTH$SEVERITY", 0);
    
  }

  private void initializeFormalParameters(final IEclipsePreferences preferences) {
    preferences.put("COM.AVALOQ.TOOLS.DDK.CHECK.VALIDATION.EXECUTIONENVIRONMENTISSUECODES.GREETINGNAMELENGTH.DEFAULTNAME$PARAMETER", GET_GREETING_NAME_LENGTH_DEFAULT_NAME_DEFAULT);
