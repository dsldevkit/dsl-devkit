...
public class TestLanguageParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	@Override
	protected com.avaloq.tools.ddk.check.parser.antlr.internal.InternalTestLanguageParser createParser(XtextTokenStream stream) {
		return new com.avaloq.tools.ddk.check.parser.antlr.internal.InternalTestLanguageParser(stream, getGrammarAccess());
	}
