/**
 */
package com.avaloq.tools.ddk.check.testLanguage.util;

import com.avaloq.tools.ddk.check.testLanguage.*;
...
public class TestLanguageAdapterFactory extends AdapterFactoryImpl
{
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.avaloq.tools.ddk.check.testLanguage.Model <em>Model</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link com.avaloq.tools.ddk.check.testLanguage.Greeting <em>Greeting</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
