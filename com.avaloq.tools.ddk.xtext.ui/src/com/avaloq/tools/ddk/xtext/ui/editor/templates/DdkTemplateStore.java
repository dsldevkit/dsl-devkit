 ...
 */
@Singleton
public class DdkTemplateStore extends TemplateStore {

  private static final Logger LOG = Logger.getLogger(DdkTemplateStore.class);
  ...
  @Inject
  public DdkTemplateStore(final ContextTypeRegistry registry, final IPreferenceStore store, @Named(Constants.LANGUAGE_NAME) final String key, final AbstractUIPlugin plugin) {
