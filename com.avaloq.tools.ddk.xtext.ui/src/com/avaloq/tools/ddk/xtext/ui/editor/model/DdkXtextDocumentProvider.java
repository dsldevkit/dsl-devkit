...
/**
 * The DDK Xtext document-provider.
 */
@Singleton
public class DdkXtextDocumentProvider extends XtextDocumentProvider implements IPropertyChangeListener {
  @Inject
  ...
  /** Class-wide logger. */
  private static final Logger LOGGER = Logger.getLogger(DdkXtextDocumentProvider.class);
