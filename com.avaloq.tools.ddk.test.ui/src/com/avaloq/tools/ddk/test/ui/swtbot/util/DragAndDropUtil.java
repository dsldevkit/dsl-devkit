...
public class DragAndDropUtil {
   ...
   */
  private static final int DRAG_THRESHOLD = "gtk".equals(SWT.getPlatform()) ? DRAG_THRESHOLD_LINUX : DRAG_THRESHOLD_WIN;
  ...
  private static <T extends Widget> Rectangle absoluteLocation(final AbstractSWTBot<T> item) {
    ...
    if (item instanceof SWTBotTreeItem) {
      ...
      // XXX : this cast is unchecked and needs to be verified to be always correct.
