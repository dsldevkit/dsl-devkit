...
public class ValidValidatorFragment extends JavaValidatorFragment {
  ...
  public Set<Binding> getGuiceBindingsRt(final Grammar grammar) {
    ...
    return new BindFactory().addTypeToType(getJavaValidatorName(grammar, ""), getJavaValidatorName(grammar, "")).addTypeToType(CompositeEValidator.class.getName(), ValidCompositeEValidator.class.getName()).getBindings(); //$NON-NLS-1$ //$NON-NLS-2$
  }
