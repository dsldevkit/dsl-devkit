...
public class CheckParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CheckGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCheckAccess().getAlternatives_8(), "rule__Check__Alternatives_8");
			...
			builder.put(grammarAccess.getCheckAccess().getGroup_6(), "rule__Check__Group_6__0");
			builder.put(grammarAccess.getCheckAccess().getGroup_6_1(), "rule__Check__Group_6_1__0");
			builder.put(grammarAccess.getCheckAccess().getGroup_6_1_1(), "rule__Check__Group_6_1_1__0");
			builder.put(grammarAccess.getCheckAccess().getGroup_7(), "rule__Check__Group_7__0");
			builder.put(grammarAccess.getCheckAccess().getGroup_8_0(), "rule__Check__Group_8_0__0");
			...
			builder.put(grammarAccess.getXIssueExpressionAccess().getGroup_5_3(), "rule__XIssueExpression__Group_5_3__0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getGroup_6(), "rule__XIssueExpression__Group_6__0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getGroup_6_4(), "rule__XIssueExpression__Group_6_4__0");
			...
			builder.put(grammarAccess.getCheckAccess().getKindAssignment_2(), "rule__Check__KindAssignment_2");
			builder.put(grammarAccess.getCheckAccess().getDefaultSeverityAssignment_3(), "rule__Check__DefaultSeverityAssignment_3");
			builder.put(grammarAccess.getCheckAccess().getIdAssignment_4(), "rule__Check__IdAssignment_4");
			builder.put(grammarAccess.getCheckAccess().getLabelAssignment_5(), "rule__Check__LabelAssignment_5");
			builder.put(grammarAccess.getCheckAccess().getFormalParametersAssignment_6_1_0(), "rule__Check__FormalParametersAssignment_6_1_0");
			builder.put(grammarAccess.getCheckAccess().getFormalParametersAssignment_6_1_1_1(), "rule__Check__FormalParametersAssignment_6_1_1_1");
			builder.put(grammarAccess.getCheckAccess().getGivenMessageAssignment_7_1(), "rule__Check__GivenMessageAssignment_7_1");
			builder.put(grammarAccess.getCheckAccess().getContextsAssignment_8_0_1(), "rule__Check__ContextsAssignment_8_0_1");
			builder.put(grammarAccess.getCheckAccess().getContextsAssignment_8_1(), "rule__Check__ContextsAssignment_8_1");
			...
			builder.put(grammarAccess.getXIssueExpressionAccess().getMarkerFeatureAssignment_3_1_0_1(), "rule__XIssueExpression__MarkerFeatureAssignment_3_1_0_1");
			...
			builder.put(grammarAccess.getXIssueExpressionAccess().getMarkerFeatureAssignment_3_1_1_1_1(), "rule__XIssueExpression__MarkerFeatureAssignment_3_1_1_1_1");
			...
			builder.put(grammarAccess.getXIssueExpressionAccess().getMessageAssignment_4_1(), "rule__XIssueExpression__MessageAssignment_4_1");
			builder.put(grammarAccess.getXIssueExpressionAccess().getMessageParametersAssignment_5_2(), "rule__XIssueExpression__MessageParametersAssignment_5_2");
			builder.put(grammarAccess.getXIssueExpressionAccess().getMessageParametersAssignment_5_3_1(), "rule__XIssueExpression__MessageParametersAssignment_5_3_1");
			builder.put(grammarAccess.getXIssueExpressionAccess().getIssueCodeAssignment_6_1(), "rule__XIssueExpression__IssueCodeAssignment_6_1");
			builder.put(grammarAccess.getXIssueExpressionAccess().getIssueDataAssignment_6_3(), "rule__XIssueExpression__IssueDataAssignment_6_3");
			builder.put(grammarAccess.getXIssueExpressionAccess().getIssueDataAssignment_6_4_1(), "rule__XIssueExpression__IssueDataAssignment_6_4_1");
