 ...
 * generated by Xtext
 */
package com.avaloq.tools.ddk.check.ide.contentassist.antlr;

import com.avaloq.tools.ddk.check.ide.contentassist.antlr.internal.InternalCheckParser;
...
public class CheckParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(CheckGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CheckGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getCheckCatalogAccess().getAlternatives_9(), "rule__CheckCatalog__Alternatives_9");
			builder.put(grammarAccess.getXImportDeclarationAccess().getAlternatives_1(), "rule__XImportDeclaration__Alternatives_1");
			builder.put(grammarAccess.getDocumentedAccess().getAlternatives(), "rule__Documented__Alternatives");
			builder.put(grammarAccess.getImplicitlyNamedAccess().getAlternatives(), "rule__ImplicitlyNamed__Alternatives");
			builder.put(grammarAccess.getCheckAccess().getAlternatives_9(), "rule__Check__Alternatives_9");
			builder.put(grammarAccess.getXSimpleFormalParameterDefaultValueLiteralAccess().getAlternatives(), "rule__XSimpleFormalParameterDefaultValueLiteral__Alternatives");
			builder.put(grammarAccess.getXConstantUnaryOperationAccess().getAlternatives(), "rule__XConstantUnaryOperation__Alternatives");
			builder.put(grammarAccess.getXFormalParameterDefaultValueLiteralAccess().getAlternatives(), "rule__XFormalParameterDefaultValueLiteral__Alternatives");
			builder.put(grammarAccess.getXIssueExpressionAccess().getAlternatives_3_1(), "rule__XIssueExpression__Alternatives_3_1");
			builder.put(grammarAccess.getXIssueExpressionAccess().getAlternatives_3_1_0_1(), "rule__XIssueExpression__Alternatives_3_1_0_1");
			builder.put(grammarAccess.getXIssueExpressionAccess().getAlternatives_3_1_1_1_1(), "rule__XIssueExpression__Alternatives_3_1_1_1_1");
			...
			builder.put(grammarAccess.getCheckCatalogAccess().getGroup(), "rule__CheckCatalog__Group__0");
			builder.put(grammarAccess.getCheckCatalogAccess().getGroup_7(), "rule__CheckCatalog__Group_7__0");
			builder.put(grammarAccess.getXImportSectionAccess().getGroup(), "rule__XImportSection__Group__0");
			...
			builder.put(grammarAccess.getCheckAccess().getGroup_7(), "rule__Check__Group_7__0");
			builder.put(grammarAccess.getCheckAccess().getGroup_7_1(), "rule__Check__Group_7_1__0");
			builder.put(grammarAccess.getCheckAccess().getGroup_7_1_1(), "rule__Check__Group_7_1_1__0");
			builder.put(grammarAccess.getCheckAccess().getGroup_8(), "rule__Check__Group_8__0");
			builder.put(grammarAccess.getCheckAccess().getGroup_9_0(), "rule__Check__Group_9_0__0");
			builder.put(grammarAccess.getSeverityRangeAccess().getGroup(), "rule__SeverityRange__Group__0");
			builder.put(grammarAccess.getMemberAccess().getGroup(), "rule__Member__Group__0");
			builder.put(grammarAccess.getMemberAccess().getGroup_3(), "rule__Member__Group_3__0");
			...
			builder.put(grammarAccess.getXConstantUnaryOperationAccess().getGroup_0(), "rule__XConstantUnaryOperation__Group_0__0");
			builder.put(grammarAccess.getXConstantListLiteralAccess().getGroup(), "rule__XConstantListLiteral__Group__0");
			builder.put(grammarAccess.getXConstantListLiteralAccess().getGroup_3(), "rule__XConstantListLiteral__Group_3__0");
			builder.put(grammarAccess.getXConstantListLiteralAccess().getGroup_3_1(), "rule__XConstantListLiteral__Group_3_1__0");
			builder.put(grammarAccess.getContextAccess().getGroup(), "rule__Context__Group__0");
			builder.put(grammarAccess.getContextVariableAccess().getGroup(), "rule__ContextVariable__Group__0");
			builder.put(grammarAccess.getXGuardExpressionAccess().getGroup(), "rule__XGuardExpression__Group__0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getGroup(), "rule__XIssueExpression__Group__0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getGroup_3(), "rule__XIssueExpression__Group_3__0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getGroup_3_1_0(), "rule__XIssueExpression__Group_3_1_0__0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getGroup_3_1_0_1_1(), "rule__XIssueExpression__Group_3_1_0_1_1__0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getGroup_3_1_1(), "rule__XIssueExpression__Group_3_1_1__0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getGroup_3_1_1_1(), "rule__XIssueExpression__Group_3_1_1_1__0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getGroup_3_1_1_1_1_1(), "rule__XIssueExpression__Group_3_1_1_1_1_1__0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getGroup_3_2(), "rule__XIssueExpression__Group_3_2__0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getGroup_4(), "rule__XIssueExpression__Group_4__0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getGroup_5(), "rule__XIssueExpression__Group_5__0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getGroup_6(), "rule__XIssueExpression__Group_6__0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getGroup_6_3(), "rule__XIssueExpression__Group_6_3__0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getGroup_7(), "rule__XIssueExpression__Group_7__0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getGroup_7_4(), "rule__XIssueExpression__Group_7_4__0");
			...
			builder.put(grammarAccess.getCheckCatalogAccess().getPackageNameAssignment_2(), "rule__CheckCatalog__PackageNameAssignment_2");
			builder.put(grammarAccess.getCheckCatalogAccess().getImportsAssignment_3(), "rule__CheckCatalog__ImportsAssignment_3");
			builder.put(grammarAccess.getCheckCatalogAccess().getFinalAssignment_4(), "rule__CheckCatalog__FinalAssignment_4");
			builder.put(grammarAccess.getCheckCatalogAccess().getNameAssignment_6(), "rule__CheckCatalog__NameAssignment_6");
			builder.put(grammarAccess.getCheckCatalogAccess().getGrammarAssignment_7_2(), "rule__CheckCatalog__GrammarAssignment_7_2");
			builder.put(grammarAccess.getCheckCatalogAccess().getCategoriesAssignment_9_0(), "rule__CheckCatalog__CategoriesAssignment_9_0");
			builder.put(grammarAccess.getCheckCatalogAccess().getImplementationsAssignment_9_1(), "rule__CheckCatalog__ImplementationsAssignment_9_1");
			builder.put(grammarAccess.getCheckCatalogAccess().getChecksAssignment_9_2(), "rule__CheckCatalog__ChecksAssignment_9_2");
			builder.put(grammarAccess.getCheckCatalogAccess().getMembersAssignment_9_3(), "rule__CheckCatalog__MembersAssignment_9_3");
			builder.put(grammarAccess.getXImportSectionAccess().getImportDeclarationsAssignment_1(), "rule__XImportSection__ImportDeclarationsAssignment_1");
			builder.put(grammarAccess.getXImportDeclarationAccess().getImportedTypeAssignment_1_0(), "rule__XImportDeclaration__ImportedTypeAssignment_1_0");
			builder.put(grammarAccess.getXImportDeclarationAccess().getImportedNamespaceAssignment_1_1(), "rule__XImportDeclaration__ImportedNamespaceAssignment_1_1");
			builder.put(grammarAccess.getCategoryAccess().getIdAssignment_1(), "rule__Category__IdAssignment_1");
			builder.put(grammarAccess.getCategoryAccess().getLabelAssignment_2(), "rule__Category__LabelAssignment_2");
			builder.put(grammarAccess.getCategoryAccess().getChecksAssignment_4(), "rule__Category__ChecksAssignment_4");
			builder.put(grammarAccess.getCheckAccess().getSeverityRangeAssignment_0(), "rule__Check__SeverityRangeAssignment_0");
			builder.put(grammarAccess.getCheckAccess().getFinalAssignment_1(), "rule__Check__FinalAssignment_1");
			builder.put(grammarAccess.getCheckAccess().getExternalAssignment_2(), "rule__Check__ExternalAssignment_2");
			builder.put(grammarAccess.getCheckAccess().getKindAssignment_3(), "rule__Check__KindAssignment_3");
			builder.put(grammarAccess.getCheckAccess().getDefaultSeverityAssignment_4(), "rule__Check__DefaultSeverityAssignment_4");
			builder.put(grammarAccess.getCheckAccess().getIdAssignment_5(), "rule__Check__IdAssignment_5");
			builder.put(grammarAccess.getCheckAccess().getLabelAssignment_6(), "rule__Check__LabelAssignment_6");
			builder.put(grammarAccess.getCheckAccess().getFormalParametersAssignment_7_1_0(), "rule__Check__FormalParametersAssignment_7_1_0");
			builder.put(grammarAccess.getCheckAccess().getFormalParametersAssignment_7_1_1_1(), "rule__Check__FormalParametersAssignment_7_1_1_1");
			builder.put(grammarAccess.getCheckAccess().getGivenMessageAssignment_8_1(), "rule__Check__GivenMessageAssignment_8_1");
			builder.put(grammarAccess.getCheckAccess().getContextsAssignment_9_0_1(), "rule__Check__ContextsAssignment_9_0_1");
			builder.put(grammarAccess.getCheckAccess().getContextsAssignment_9_1(), "rule__Check__ContextsAssignment_9_1");
			builder.put(grammarAccess.getSeverityRangeAccess().getMinSeverityAssignment_3(), "rule__SeverityRange__MinSeverityAssignment_3");
			builder.put(grammarAccess.getSeverityRangeAccess().getMaxSeverityAssignment_5(), "rule__SeverityRange__MaxSeverityAssignment_5");
			builder.put(grammarAccess.getMemberAccess().getAnnotationsAssignment_0(), "rule__Member__AnnotationsAssignment_0");
			builder.put(grammarAccess.getMemberAccess().getTypeAssignment_1(), "rule__Member__TypeAssignment_1");
			builder.put(grammarAccess.getMemberAccess().getNameAssignment_2(), "rule__Member__NameAssignment_2");
			builder.put(grammarAccess.getMemberAccess().getValueAssignment_3_1(), "rule__Member__ValueAssignment_3_1");
			builder.put(grammarAccess.getImplementationAccess().getNameAssignment_1(), "rule__Implementation__NameAssignment_1");
			builder.put(grammarAccess.getImplementationAccess().getContextAssignment_2(), "rule__Implementation__ContextAssignment_2");
			...
			builder.put(grammarAccess.getFormalParameterAccess().getRightAssignment_3(), "rule__FormalParameter__RightAssignment_3");
			builder.put(grammarAccess.getFormalParameterAccess().getLabelAssignment_4(), "rule__FormalParameter__LabelAssignment_4");
			builder.put(grammarAccess.getXConstantUnaryOperationAccess().getFeatureAssignment_0_1(), "rule__XConstantUnaryOperation__FeatureAssignment_0_1");
			builder.put(grammarAccess.getXConstantUnaryOperationAccess().getOperandAssignment_0_2(), "rule__XConstantUnaryOperation__OperandAssignment_0_2");
			builder.put(grammarAccess.getXConstantListLiteralAccess().getElementsAssignment_3_0(), "rule__XConstantListLiteral__ElementsAssignment_3_0");
			builder.put(grammarAccess.getXConstantListLiteralAccess().getElementsAssignment_3_1_1(), "rule__XConstantListLiteral__ElementsAssignment_3_1_1");
			builder.put(grammarAccess.getContextAccess().getContextVariableAssignment_1(), "rule__Context__ContextVariableAssignment_1");
			builder.put(grammarAccess.getContextAccess().getConstraintAssignment_2(), "rule__Context__ConstraintAssignment_2");
			builder.put(grammarAccess.getContextVariableAccess().getTypeAssignment_0(), "rule__ContextVariable__TypeAssignment_0");
			builder.put(grammarAccess.getContextVariableAccess().getNameAssignment_1(), "rule__ContextVariable__NameAssignment_1");
			builder.put(grammarAccess.getXGuardExpressionAccess().getGuardAssignment_2(), "rule__XGuardExpression__GuardAssignment_2");
			builder.put(grammarAccess.getXIssueExpressionAccess().getCheckAssignment_2(), "rule__XIssueExpression__CheckAssignment_2");
			builder.put(grammarAccess.getXIssueExpressionAccess().getMarkerFeatureAssignment_3_1_0_1_0(), "rule__XIssueExpression__MarkerFeatureAssignment_3_1_0_1_0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getMarkerFeatureExpressionAssignment_3_1_0_1_1_1(), "rule__XIssueExpression__MarkerFeatureExpressionAssignment_3_1_0_1_1_1");
			builder.put(grammarAccess.getXIssueExpressionAccess().getMarkerObjectAssignment_3_1_1_0(), "rule__XIssueExpression__MarkerObjectAssignment_3_1_1_0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getMarkerFeatureAssignment_3_1_1_1_1_0(), "rule__XIssueExpression__MarkerFeatureAssignment_3_1_1_1_1_0");
			builder.put(grammarAccess.getXIssueExpressionAccess().getMarkerFeatureExpressionAssignment_3_1_1_1_1_1_1(), "rule__XIssueExpression__MarkerFeatureExpressionAssignment_3_1_1_1_1_1_1");
			builder.put(grammarAccess.getXIssueExpressionAccess().getMarkerIndexAssignment_3_2_1(), "rule__XIssueExpression__MarkerIndexAssignment_3_2_1");
			builder.put(grammarAccess.getXIssueExpressionAccess().getMarkerRegionAssignment_4_1(), "rule__XIssueExpression__MarkerRegionAssignment_4_1");
			builder.put(grammarAccess.getXIssueExpressionAccess().getMessageAssignment_5_1(), "rule__XIssueExpression__MessageAssignment_5_1");
			builder.put(grammarAccess.getXIssueExpressionAccess().getMessageParametersAssignment_6_2(), "rule__XIssueExpression__MessageParametersAssignment_6_2");
			builder.put(grammarAccess.getXIssueExpressionAccess().getMessageParametersAssignment_6_3_1(), "rule__XIssueExpression__MessageParametersAssignment_6_3_1");
			builder.put(grammarAccess.getXIssueExpressionAccess().getIssueCodeAssignment_7_1(), "rule__XIssueExpression__IssueCodeAssignment_7_1");
			builder.put(grammarAccess.getXIssueExpressionAccess().getIssueDataAssignment_7_3(), "rule__XIssueExpression__IssueDataAssignment_7_3");
			builder.put(grammarAccess.getXIssueExpressionAccess().getIssueDataAssignment_7_4_1(), "rule__XIssueExpression__IssueDataAssignment_7_4_1");
	...
	@Override
	protected InternalCheckParser createParser() {
		InternalCheckParser result = new InternalCheckParser(null);
