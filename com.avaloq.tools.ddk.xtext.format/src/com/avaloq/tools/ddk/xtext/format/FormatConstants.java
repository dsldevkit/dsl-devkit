...
/**
 * Provides language specific constants for Format.
 */
public final class FormatConstants {
  public static final String GRAMMAR = "com.avaloq.tools.ddk.xtext.format.Format"; //$NON-NLS-1$
  public static final String FILE_EXTENSION = "format"; //$NON-NLS-1$
