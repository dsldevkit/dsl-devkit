...
import com.avaloq.tools.ddk.xtext.format.formatting.FormatFormatter;
import com.avaloq.tools.ddk.xtext.format.jvmmodel.FormatJvmModelInferrer;
import com.avaloq.tools.ddk.xtext.format.parser.antlr.FormatAntlrTokenFileProvider;
import com.avaloq.tools.ddk.xtext.format.parser.antlr.FormatParser;
import com.avaloq.tools.ddk.xtext.format.parser.antlr.internal.InternalFormatLexer;
import com.avaloq.tools.ddk.xtext.format.scoping.FormatScopeProvider;
import com.avaloq.tools.ddk.xtext.format.serializer.FormatSemanticSequencer;
import com.avaloq.tools.ddk.xtext.format.serializer.FormatSyntacticSequencer;
import com.avaloq.tools.ddk.xtext.format.services.FormatGrammarAccess;
import com.avaloq.tools.ddk.xtext.format.validation.FormatConfigurableIssueCodesProvider;
...
public abstract class AbstractFormatRuntimeModule extends DefaultXbaseWithAnnotationsRuntimeModule {
	...
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public Provider<? extends InternalFormatLexer> provideInternalFormatLexer() {
	...
	public Class<? extends XbaseConfigurableIssueCodes> bindXbaseConfigurableIssueCodes() {
		return FormatConfigurableIssueCodesProvider.class;
	}
