...
public class DdkBuilderResourceLoadStrategy implements IBuilderResourceLoadStrategy {

  /** Class-wide logger. */
  private static final Logger LOGGER = Logger.getLogger(DdkBuilderResourceLoadStrategy.class);
