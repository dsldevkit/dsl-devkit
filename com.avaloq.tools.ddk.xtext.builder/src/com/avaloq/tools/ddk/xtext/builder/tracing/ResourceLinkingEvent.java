 ...
 */
public class ResourceLinkingEvent extends ResourceEvent {

  /**
   * Creates a new instance of {@link ResourceLinkingEvent}.
   *
   * @param trigger
   *          event trigger
   * @param data
   ...
   */
  public ResourceLinkingEvent(final Trigger trigger, final Object[] data) {
    super(trigger, data);
  }
