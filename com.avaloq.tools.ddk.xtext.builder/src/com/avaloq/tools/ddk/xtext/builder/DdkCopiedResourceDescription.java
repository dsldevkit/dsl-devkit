 ...
 */
public class DdkCopiedResourceDescription extends AbstractResourceDescription implements IResourceDescription2 {

  private final URI uri;
  private final ImmutableList<IEObjectDescription> exported;

  public DdkCopiedResourceDescription(final IResourceDescription original) {
    super();
