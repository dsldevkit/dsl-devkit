...
public abstract class AbstractCheckSyntacticSequencer extends AbstractSyntacticSequencer {
	 ...
	 *     formalParameters+=FormalParameter ')' (ambiguity) (rule end)
	 *     givenMessage=STRING (ambiguity) (rule end)
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     label=STRING (ambiguity) 'message' givenMessage=STRING
	 *     label=STRING (ambiguity) '{' contexts+=Context
	 *     label=STRING (ambiguity) ('{' '}')? (rule end)
	 *     label=STRING (ambiguity) contexts+=Context
