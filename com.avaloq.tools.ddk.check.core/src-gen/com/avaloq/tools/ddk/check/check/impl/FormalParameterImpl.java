...
public class FormalParameterImpl extends MinimalEObjectImpl.Container implements FormalParameter
{
  ...
  {
    return CheckPackage.Literals.FORMAL_PARAMETER;
  }
  ...
  public NotificationChain basicSetType(JvmTypeReference newType, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CheckPackage.FORMAL_PARAMETER__TYPE, oldType, newType);
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CheckPackage.FORMAL_PARAMETER__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetRight(XExpression newRight, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CheckPackage.FORMAL_PARAMETER__RIGHT, oldRight, newRight);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setRight(XExpression newRight)
  {
    if (newRight != right)
    {
      NotificationChain msgs = null;
      if (right != null)
        msgs = ((InternalEObject)right).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CheckPackage.FORMAL_PARAMETER__RIGHT, null, msgs);
      if (newRight != null)
        msgs = ((InternalEObject)newRight).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CheckPackage.FORMAL_PARAMETER__RIGHT, null, msgs);
      msgs = basicSetRight(newRight, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CheckPackage.FORMAL_PARAMETER__RIGHT, newRight, newRight));
  }
  ...
  public void setLabel(String newLabel)
  {
    ...
    label = newLabel;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CheckPackage.FORMAL_PARAMETER__LABEL, oldLabel, label));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CheckPackage.FORMAL_PARAMETER__TYPE:
        return basicSetType(null, msgs);
      case CheckPackage.FORMAL_PARAMETER__RIGHT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CheckPackage.FORMAL_PARAMETER__TYPE:
        return getType();
      case CheckPackage.FORMAL_PARAMETER__NAME:
        return getName();
      case CheckPackage.FORMAL_PARAMETER__RIGHT:
        return getRight();
      case CheckPackage.FORMAL_PARAMETER__LABEL:
        return getLabel();
    }
