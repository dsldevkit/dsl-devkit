...
public class CheckGenerator extends JvmModelGenerator {
  ...
  public CharSequence bodyDoc(final CheckCatalog catalog) {
    ...
    for (Check check : catalog.getChecks()) {
      sb.append("<div id=\"").append(checkGeneratorNaming.getContextId(check))
    ...
    for (Category category : catalog.getCategories()) {
      ...
      sb.append("  <h2 id=\"").append(checkGeneratorNaming.getContextId(category))
  ...
  public CharSequence compileStandaloneSetup(final CheckCatalog catalog) {
    ...
    sb.append("public class ").append(checkGeneratorNaming.standaloneSetupClassName(catalog))
    ...
    sb.append("      ").append(checkGeneratorNaming.standaloneSetupClassName(catalog))
