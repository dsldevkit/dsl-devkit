...
public class FormatValidationTest extends AbstractValidationTest {
  ...
  public void testNegativeACF1000() {
    ...
    assertDiagnostic(parentFormat, Format2Validator.ILLEGAL_DIRECTIVE_CODE);
  }
  ...
  public void testPositiveACF1000() {
    ...
    assertNoDiagnostic(parentFormat, Format2Validator.ILLEGAL_DIRECTIVE_CODE);
  }
  ...
  public void illegalWildcardRuleOverride() {
    ...
    assertDiagnostic(extendingFormat, Format2Validator.OVERRIDE_ILLEGAL_CODE);
  }
  ...
  public void missingWildcardRuleOverride() {
    ...
    assertDiagnostic(extendingFormat, Format2Validator.OVERRIDE_MISSING_CODE);
  }
  ...
  public void wildcardRuleOverrideOK() {
    ...
    assertNoDiagnostic(extendingFormat, Format2Validator.OVERRIDE_MISSING_CODE);
    assertNoDiagnostic(extendingFormat, Format2Validator.OVERRIDE_ILLEGAL_CODE);
  }
  ...
  public void extendedGrammarCompatible() {
    ...
    assertDiagnostic(myDslModel, Format2Validator.EXTENDED_GRAMMAR_INCOMPATIBLE_CODE);
  }
  ...
  public void extendedGrammarCompatibleOK() {
    ...
    assertNoDiagnostic(extendModel, Format2Validator.EXTENDED_GRAMMAR_INCOMPATIBLE_CODE);
  }
  ...
  public void requiredRulesImplemented() {
    ...
    assertDiagnostic(extendingFormat, Format2Validator.GRAMMAR_RULE_MISSING_CODE);
  }
}
