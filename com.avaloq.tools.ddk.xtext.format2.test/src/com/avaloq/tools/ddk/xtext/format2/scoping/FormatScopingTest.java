...
import com.avaloq.tools.ddk.xtext.format2.format2.GroupBlock;
...
public class FormatScopingTest extends AbstractScopingTest {
  ...
  public void allGrammarsScoped() {
    ...
    assertScope(formatC, Format2Package.Literals.GRAMMAR_RULE__TARGET_RULE, expectedURIs);
  }
  ...
  public void keywordScoped() {
    ...
    assertScope(formatC.getRules().get(0), Format2Package.Literals.GRAMMAR_ELEMENT_REFERENCE__KEYWORD, keywordURIs);
    assertScope(formatA.getRules().get(0), Format2Package.Literals.GRAMMAR_ELEMENT_REFERENCE__KEYWORD, keywordURIs);

    keywordURIs = Sets.newHashSet(Iterables.transform(GrammarUtil.containedKeywords(parserRuleC), TO_URI));
    assertScope(formatC.getRules().get(2), Format2Package.Literals.GRAMMAR_ELEMENT_REFERENCE__KEYWORD, keywordURIs);
  }
  ...
  public void assignmentScoped() {
    ...
    assertScope(formatC.getRules().get(0), Format2Package.Literals.GRAMMAR_ELEMENT_REFERENCE__ASSIGNMENT, assignmentURIs);
    assertScope(formatA.getRules().get(0), Format2Package.Literals.GRAMMAR_ELEMENT_REFERENCE__ASSIGNMENT, assignmentURIs);
  }
  ...
  public void ruleCallScoped() {
    ...
    assertScope(formatA.getRules().get(1), Format2Package.Literals.GRAMMAR_ELEMENT_REFERENCE__RULE_CALL, ruleCallURIs);
    assertScope(formatC.getRules().get(1), Format2Package.Literals.GRAMMAR_ELEMENT_REFERENCE__RULE_CALL, ruleCallURIs);
  }
  ...
  public void ruleSelfScoped() {
    AbstractRule parserRuleA = grammarA.getRules().get(0);
    assertScope(formatC.getRules().get(0), Format2Package.Literals.GRAMMAR_ELEMENT_REFERENCE__SELF, TO_URI.apply(parserRuleA));
  }
  ...
  public void groupScoped() {
    ...
    assertScope(groupRef1, Format2Package.Literals.GROUP_BLOCK__GRAMMAR_ELEMENT, TO_URI.apply(group1));
    assertScope(groupRef12, Format2Package.Literals.GROUP_BLOCK__GRAMMAR_ELEMENT, TO_URI.apply(group11), TO_URI.apply(group12));
    assertScope(groupRef121, Format2Package.Literals.GROUP_BLOCK__GRAMMAR_ELEMENT, TO_URI.apply(group121));
    assertScope(groupRef1212, Format2Package.Literals.GROUP_BLOCK__GRAMMAR_ELEMENT, TO_URI.apply(group1211), TO_URI.apply(group1212));
